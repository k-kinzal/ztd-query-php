...
use SqlFaker\Sqlite\Generation\Tokenization\KeywordIndex;
use SqlFaker\Sqlite\Generation\Tokenization\SqliteTokenizer;
...
#[UsesClass(\SqlFaker\Sqlite\Generation\Tokenization\SqliteQuoting::class)]
...
SQL;
    ...
    {
        $lexical = new LexicalGrammar(Factory::create(), 'sqlite-3.47.2');
        $output = $lexical->resolveSequence(TerminalSequence::fromNames(['INTEGER']), null, static fn (int $count): int => $count - 1);
