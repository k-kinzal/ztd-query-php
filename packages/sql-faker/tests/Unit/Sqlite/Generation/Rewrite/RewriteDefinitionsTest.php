...
namespace Tests\Unit\Sqlite\Generation\Rewrite;
...
final class RewriteDefinitionsTest extends TestCase
{
    ...
    {
        $expression = new \SqlFaker\Generation\Token\TerminalOccurrence('ID', 2, [0, 1], ['generated', 'expr']);
        $storage = new \SqlFaker\Generation\Token\TerminalOccurrence('ID', 3, [0], ['generated']);
        $plain = new \SqlFaker\Generation\Token\TerminalOccurrence('ID', 4, [5], ['nm']);
        $input = new \SqlFaker\Generation\Token\TerminalSequence([$expression, $storage, $plain], [$expression, $storage, $plain]);
