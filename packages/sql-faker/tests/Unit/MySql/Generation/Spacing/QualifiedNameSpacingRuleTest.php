...
namespace Tests\Unit\MySql\Generation\Spacing;
...
#[CoversClass(QualifiedNameSpacingRule::class)]
...
final class QualifiedNameSpacingRuleTest extends TestCase
{
    public function testApplyConstrainsOnlyItsSourceDefinedBoundary(): void
    {
        ...
        $left = new Lexeme('db', 'identifier', $origin, 'source');
