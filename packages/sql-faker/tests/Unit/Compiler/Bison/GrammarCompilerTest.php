...
final class GrammarCompilerTest extends TestCase
{
    ...
    public function testCompilePreservesBisonStructure(): void
    {
        $ast = new BisonAst(
            startSymbol: 'start',
            prologue: null,
    ...
    public function testCompileMergesSameNameRulesPreservesBisonStructure(): void
    {
        $ast = new BisonAst(
            startSymbol: 'stmt',
            prologue: null,
    ...
    public function testCompileThrowsOnUnknownSymbolPreservesBisonStructure(): void
    {
        $ast = new BisonAst(
            startSymbol: 'start',
            prologue: null,
