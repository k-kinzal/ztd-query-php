...
namespace Tests\Unit\Generation\Lexeme;
...
use SqlFaker\PostgreSql\Generation\StatementRule as PostgreSqlStatementRule;
...
final class LexicalGrammarTest extends TestCase
{
    ...
    {
        $lexical = new MySqlLexicalGrammar(Factory::create(), 'mysql-8.4.7');
        $sequence = \SqlFaker\Generation\Token\TerminalSequence::fromNames(['NUM']);
