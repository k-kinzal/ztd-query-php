...
use SqlFaker\PostgreSqlLiteralProvider;

#[CoversClass(PostgreSqlLiteralProvider::class)]
final class PostgreSqlLiteralProviderTest extends TestCase
{
    public function testRegistersItselfWithTheFakerGenerator(): void
    {
        $faker = Factory::create();
        $provider = new PostgreSqlLiteralProvider($faker);
    ...
    public function testQuotedIdentifierDefaultMatchesExplicit(): void
    {
        ...
        $faker->seed(42);
        self::assertSame($a, $provider->quotedIdentifier(1, 63));
    }
    ...
    public function testFloatLiteralDefaultMatchesExplicit(): void
    {
        ...
        $faker->seed(42);
        self::assertSame($a, $provider->floatLiteral(10, 2, -307, 308));
    }
    ...
    public function testParameterMarkerDefaultMatchesExplicit(): void
    {
        ...
        $provider = new PostgreSqlLiteralProvider($faker);
        $faker->seed(42);
        $a = $provider->parameterMarker();
        $faker->seed(42);
        self::assertSame($a, $provider->parameterMarker(1, 99));
    }
