...
final class LexicalGrammarTest extends TestCase
{
    ...
    public function testResolveSequenceUsesTheCommonContractForCandidateInspection(): void
    {
        ...
        self::assertCount(1, $lexical->resolveSequence(\SqlFaker\Grammar\Generation\Token\TerminalSequence::fromNames(['INTEGER']), null, static fn (int $count): int => 0)->candidates);
    }
}
