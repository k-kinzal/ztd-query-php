...
enum StatementRule: string
{
     ...
     *     \SqlFaker\MySql\Generation\StatementRule::Select->value // => 'select_stmt'
     */
    case Select = 'select_stmt';
    /**
     * @visibility public
     * @example Choose the Insert grammar rule
     *     \SqlFaker\MySql\Generation\StatementRule::Insert->value // => 'insert_stmt'
     */
    case Insert = 'insert_stmt';
    /**
     * @visibility public
     * @example Choose the Update grammar rule
     *     \SqlFaker\MySql\Generation\StatementRule::Update->value // => 'update_stmt'
     */
    case Update = 'update_stmt';
    /**
     * @visibility public
     * @example Choose the Delete grammar rule
     *     \SqlFaker\MySql\Generation\StatementRule::Delete->value // => 'delete_stmt'
     */
    case Delete = 'delete_stmt';
    /**
     * @visibility public
     * @example Choose the CreateTable grammar rule
     *     \SqlFaker\MySql\Generation\StatementRule::CreateTable->value // => 'create_table_stmt'
     */
    case CreateTable = 'create_table_stmt';
    /**
     * @visibility public
     * @example Choose the AlterTable grammar rule
     *     \SqlFaker\MySql\Generation\StatementRule::AlterTable->value // => 'alter_table_stmt'
     */
    case AlterTable = 'alter_table_stmt';
    /**
     * @visibility public
     * @example Choose the DropTable grammar rule
     *     \SqlFaker\MySql\Generation\StatementRule::DropTable->value // => 'drop_table_stmt'
     */
    case DropTable = 'drop_table_stmt';
    /**
     * @visibility public
     * @example Choose the SimpleStatement grammar rule
     *     \SqlFaker\MySql\Generation\StatementRule::SimpleStatement->value // => 'simple_statement'
     */
