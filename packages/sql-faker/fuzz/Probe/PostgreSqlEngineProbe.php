...
/**
 * Probes PostgreSQL by executing generated SQL inside a savepoint-backed
 * transaction, so parser and execution errors can be observed without leaving
 * persistent side effects behind.
 */
final class PostgreSqlEngineProbe implements EngineProbe
{
    ...
    /**
     * Executes the statement in PostgreSQL and captures the resulting SQLSTATE,
     * error code, and phase in a normalized probe result.
     */
