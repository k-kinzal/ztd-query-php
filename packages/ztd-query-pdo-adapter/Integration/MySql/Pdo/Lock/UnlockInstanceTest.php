...
{
    public function testUnlockInstanceThrowsExceptionInExceptionMode(): void
    {
        ...
        $ztdPdo->exec('UNLOCK INSTANCE');
    }

    public function testUnlockInstanceIsIgnoredInIgnoreMode(): void
    {
        $ztdPdo = $this->createZtdPdoWithConfig(new ZtdConfig(
            unsupportedBehavior: UnsupportedSqlBehavior::Ignore
        ));

        $result = $ztdPdo->exec('UNLOCK INSTANCE');

        $this->assertSame(0, $result);
    }

    public function testUnlockInstanceTriggersNoticeInNoticeMode(): void
    {
        $ztdPdo = $this->createZtdPdoWithConfig(new ZtdConfig(
        ...
        try {
            ...
            $this->assertStringContainsString('UNLOCK INSTANCE', $capturedNotices[0]);
        } finally {
