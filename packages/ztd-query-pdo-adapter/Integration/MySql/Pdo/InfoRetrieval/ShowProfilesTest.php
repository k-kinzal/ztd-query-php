...
final class ShowProfilesTest extends MySqlIntegrationTestCase
{
    public function testShowProfilesThrowsExceptionInExceptionMode(): void
    {
        ...
        $ztdPdo->query('SHOW PROFILES');
    }

    public function testShowProfilesIsIgnoredInIgnoreMode(): void
    {
        $ztdPdo = $this->createZtdPdoWithConfig(new ZtdConfig(
            unsupportedBehavior: UnsupportedSqlBehavior::Ignore
        ));

        $result = $ztdPdo->query('SHOW PROFILES');

        $this->assertFalse($result);
    }

    public function testShowProfilesTriggersNoticeInNoticeMode(): void
    {
        $ztdPdo = $this->createZtdPdoWithConfig(new ZtdConfig(
        ...
        try {
            ...
            $this->assertStringContainsString('SHOW PROFILES', $capturedNotices[0]);
        } finally {
