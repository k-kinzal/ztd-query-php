...
final class DropEventTest extends MySqlIntegrationTestCase
{
    public function testDropEventThrowsExceptionInExceptionMode(): void
    {
        ...
        $ztdPdo->exec('DROP EVENT test_event');
    }

    public function testDropEventIsIgnoredInIgnoreMode(): void
    {
        $ztdPdo = $this->createZtdPdoWithConfig(new ZtdConfig(
            unsupportedBehavior: UnsupportedSqlBehavior::Ignore
        ));

        $result = $ztdPdo->exec('DROP EVENT test_event');

        $this->assertSame(0, $result);
    }

    public function testDropEventTriggersNoticeInNoticeMode(): void
    {
        $ztdPdo = $this->createZtdPdoWithConfig(new ZtdConfig(
        ...
        try {
            ...
            $this->assertStringContainsString('DROP EVENT', $capturedNotices[0]);
        } finally {
