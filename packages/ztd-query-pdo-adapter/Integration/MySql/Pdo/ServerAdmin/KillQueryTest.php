...
final class KillQueryTest extends MySqlIntegrationTestCase
{
    public function testKillQueryThrowsExceptionInExceptionMode(): void
    {
        ...
        $ztdPdo->exec('KILL QUERY 12345');
    }

    public function testKillQueryIsIgnoredInIgnoreMode(): void
    {
        $ztdPdo = $this->createZtdPdoWithConfig(new ZtdConfig(
            unsupportedBehavior: UnsupportedSqlBehavior::Ignore
        ));

        $result = $ztdPdo->exec('KILL QUERY 12345');

        $this->assertSame(0, $result);
    }

    public function testKillQueryTriggersNoticeInNoticeMode(): void
    {
        $ztdPdo = $this->createZtdPdoWithConfig(new ZtdConfig(
        ...
        try {
            ...
            $this->assertStringContainsString('KILL QUERY', $capturedNotices[0]);
        } finally {
