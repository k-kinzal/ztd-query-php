...
final class DeleteBasicTest extends TestCase
{
    public function testDeleteSingleRow(): void
    {
        ...
        try {
            ...
            $rawPdo->exec("DELETE FROM {$table} WHERE id = 1");
            $ztdPdo->exec("DELETE FROM {$table} WHERE id = 1");
    ...
    public function testDeleteAllRowsWithCondition(): void
    {
        ...
        try {
            ...
            $rawPdo->exec("DELETE FROM {$table} WHERE 1=1");
            $ztdPdo->exec("DELETE FROM {$table} WHERE 1=1");
