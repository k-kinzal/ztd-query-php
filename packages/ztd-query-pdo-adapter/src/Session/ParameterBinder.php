...
final class ParameterBinder
{
     ...
     * @template TValue
     * @param array<int|string, TValue>|null $params Parameters as the caller passed them, or null to run what is already bound
     *
    ...
    public function execute(PDOStatement $statement, ?array $params): bool
    {
        ...
        foreach ($params as $key => $value) {
            ...
            if (!$statement->bindValue($parameter, $value, ParameterKind::fromType(gettype($value)))) {
                return false;
            }
        }
