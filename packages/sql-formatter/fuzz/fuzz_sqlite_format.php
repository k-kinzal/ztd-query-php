...
/**
 * PHP-Fuzzer entry point: bytes read as SQLite text must format cleanly or be rejected by the parser.
 *
 * Usage:
 *   vendor/bin/php-fuzzer fuzz fuzz/fuzz_sqlite_format.php fuzz/corpus/format-sqlite/
 *
...
$target = new FormatTarget(new SqliteParser($grammarVersion), $grammarVersion);
