...
namespace ZtdQuery\Platform\MySql\Rewrite\Transformer\Set;
...
final class OrderRewriter
{
     ...
     *
     * @param array<string, array{viewSql: string}|array{columnTypes: array<string, ColumnDeclaration>}> $tables
     */
