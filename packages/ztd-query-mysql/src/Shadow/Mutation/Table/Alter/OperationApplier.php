...
final class OperationApplier
{
    ...
    public function applyOperation(CreateStatement $createStmt, AlterOperation $op, ShadowStore $store, TableDefinition $definition): string
    {
        ...
        if (($options->has('RENAME') !== false) && ($options->has('TO') !== false) && !\ZtdQuery\Platform\MySql\Sql\Alter\OptionList::hasAny($options, ['INDEX', 'KEY', 'COLUMN'])) {
        ...
        } elseif (($options->has('FOREIGN') !== false) && \ZtdQuery\Platform\MySql\Sql\Alter\OptionList::hasAny($options, ['ADD', 'DROP'])) {
            return $this->tableName;
        ...
        } elseif (($options->has('ALTER') !== false) && (\ZtdQuery\Platform\MySql\Sql\Alter\OptionList::hasAny($options, ['SET DEFAULT', 'DROP DEFAULT']))) {
            return $this->tableName;
        } else {
