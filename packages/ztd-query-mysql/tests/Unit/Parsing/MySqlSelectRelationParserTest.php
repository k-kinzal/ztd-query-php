...
#[CoversClass(\ZtdQuery\Platform\MySql\Parsing\Relation\ReferenceReader::class)]
final class MySqlSelectRelationParserTest extends TestCase
{
    public function testTableNamesFindsPhysicalRelationsAcrossMySqlSelectScopes(): void
    {
