...
use ZtdQuery\Platform\MySql\Schema\Key\DefinitionReader;
...
final class DefinitionReaderTest extends TestCase
{
    public function testTableBody(): void
    {
        ...
        $profile = \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create();
    ...
    {
        $stream = \ZtdQuery\Sql\SqlTokenStream::tokenize('CONSTRAINT fk FOREIGN KEY (pid) REFERENCES p (id) ON DELETE CASCADE ON UPDATE SET NULL', \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create());
    ...
    {
        $stream = \ZtdQuery\Sql\SqlTokenStream::tokenize('FOREIGN KEY (a, b) REFERENCES p (x, y)', \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create());
    ...
    {
        $stream = \ZtdQuery\Sql\SqlTokenStream::tokenize('db.`parent` (id, code)', \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create());
    ...
    {
        $stream = \ZtdQuery\Sql\SqlTokenStream::tokenize('(`a`, b)', \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create());
    ...
    public function testActionCase1(): void
    {
        $reader = new DefinitionReader();
        $sql = 'CASCADE';
        $expected = \ZtdQuery\Schema\Key\ReferentialAction::Cascade;
        self::assertSame($expected, $reader->action(\ZtdQuery\Sql\SqlTokenStream::tokenize('ON DELETE ' . $sql, \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create())->significantTokens(), 'DELETE'));
        self::assertSame(\ZtdQuery\Schema\Key\ReferentialAction::NoAction, $reader->action([], 'DELETE'));
    }
    ...
    public function testActionCase2(): void
    {
        $reader = new DefinitionReader();
        $sql = 'RESTRICT';
        $expected = \ZtdQuery\Schema\Key\ReferentialAction::Restrict;
        self::assertSame($expected, $reader->action(\ZtdQuery\Sql\SqlTokenStream::tokenize('ON DELETE ' . $sql, \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create())->significantTokens(), 'DELETE'));
        self::assertSame(\ZtdQuery\Schema\Key\ReferentialAction::NoAction, $reader->action([], 'DELETE'));
    }
    ...
    public function testActionCase3(): void
    {
        $reader = new DefinitionReader();
        $sql = 'SET NULL';
        $expected = \ZtdQuery\Schema\Key\ReferentialAction::SetNull;
        self::assertSame($expected, $reader->action(\ZtdQuery\Sql\SqlTokenStream::tokenize('ON DELETE ' . $sql, \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create())->significantTokens(), 'DELETE'));
        self::assertSame(\ZtdQuery\Schema\Key\ReferentialAction::NoAction, $reader->action([], 'DELETE'));
    }
    ...
    public function testActionCase4(): void
    {
        $reader = new DefinitionReader();
        $sql = 'SET DEFAULT';
        $expected = \ZtdQuery\Schema\Key\ReferentialAction::SetDefault;
        self::assertSame($expected, $reader->action(\ZtdQuery\Sql\SqlTokenStream::tokenize('ON DELETE ' . $sql, \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create())->significantTokens(), 'DELETE'));
        self::assertSame(\ZtdQuery\Schema\Key\ReferentialAction::NoAction, $reader->action([], 'DELETE'));
    }
    ...
    public function testActionCase5(): void
    {
        $reader = new DefinitionReader();
        $sql = 'NO ACTION';
        $expected = \ZtdQuery\Schema\Key\ReferentialAction::NoAction;
        self::assertSame($expected, $reader->action(\ZtdQuery\Sql\SqlTokenStream::tokenize('ON DELETE ' . $sql, \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create())->significantTokens(), 'DELETE'));
        self::assertSame(\ZtdQuery\Schema\Key\ReferentialAction::NoAction, $reader->action([], 'DELETE'));
    }
    ...
    {
        $tokens = \ZtdQuery\Sql\SqlTokenStream::tokenize('FOREIGN KEY (a) REFERENCES p (id)', \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create())->significantTokens();
    ...
    {
        $tokens = \ZtdQuery\Sql\SqlTokenStream::tokenize('(a) REFERENCES p (id)', \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create())->significantTokens();
