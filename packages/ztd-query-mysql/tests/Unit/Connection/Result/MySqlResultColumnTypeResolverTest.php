...
use ZtdQuery\Platform\MySql\Connection\Result\MySqlMysqliResultColumnTypeResolver;
use ZtdQuery\Platform\MySql\Connection\Result\MySqlPdoResultColumnTypeResolver;
...
{
    public function testResolveSelectsResolverFromMetadataShape(): void
    {
