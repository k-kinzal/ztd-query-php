...
use ZtdQuery\Platform\MySql\Rewrite\Partition\SelectionReader;
...
final class SelectionReaderTest extends TestCase
{
    ...
    {
        $tokens = \ZtdQuery\Sql\SqlTokenStream::tokenize('t PARTITION (p0)', \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create())->significantTokens();
    ...
    {
        $tokens = \ZtdQuery\Sql\SqlTokenStream::tokenize('(p0, (p1))', \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create())->significantTokens();
        $reader = new SelectionReader();
    ...
    {
        $tokens = \ZtdQuery\Sql\SqlTokenStream::tokenize('a WHERE `JOIN` +', \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create())->significantTokens();
        $reader = new SelectionReader();
