...
use ZtdQuery\Platform\MySql\Rewrite\FullText\ExpressionEditor;
...
final class ExpressionEditorTest extends TestCase
{
    ...
    public function testExpressionEdit(): void
    {
        ...
        $stream = \ZtdQuery\Sql\SqlTokenStream::tokenize($sql, \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create());
