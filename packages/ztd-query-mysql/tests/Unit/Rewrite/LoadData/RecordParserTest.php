...
use ZtdQuery\Platform\MySql\Rewrite\LoadData\RecordParser;

#[\PHPUnit\Framework\Attributes\UsesClass(\ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::class)]
#[\PHPUnit\Framework\Attributes\UsesClass(\ZtdQuery\Platform\MySql\Rewrite\LoadData\ColumnMapping::class)]
#[\PHPUnit\Framework\Attributes\UsesClass(\ZtdQuery\Platform\MySql\Rewrite\LoadData\InputFormat::class)]
#[CoversClass(RecordParser::class)]
final class RecordParserTest extends TestCase
{
    public function testSplitRecords(): void
    {
        $format = new \ZtdQuery\Platform\MySql\Rewrite\LoadData\InputFormat(',', '"', '\\', '', "\n");
