...
use ZtdQuery\Platform\MySql\Rewrite\Transformer\MySqlSelectListAliaser;
...
#[CoversClass(\ZtdQuery\Platform\MySql\Rewrite\Transformer\Insert\InsertTarget::class)]
#[CoversClass(\ZtdQuery\Platform\MySql\Rewrite\Transformer\Insert\ResultProjection::class)]
        ...
        $tables = [
            'years' => [
                ...
                'columnTypes' => [
                    ...
                    'value' => new ColumnDeclaration(ColumnTypeFamily::INTEGER, 'YEAR'),
                ],
            ],
        ];
