...
namespace Tests\Unit\Rewrite\Transformer\Set;

use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\TestCase;
use ZtdQuery\Platform\MySql\Rewrite\Transformer\Set\OrderRewriter;
...
final class OrderRewriterTest extends TestCase
{
    ...
    {
        $tables = ['t' => ['columnTypes' => ['colors' => new \ZtdQuery\Schema\ColumnDeclaration(\ZtdQuery\Schema\ColumnTypeFamily::STRING, "SET('red','blue')")]]];
