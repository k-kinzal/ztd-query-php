...
namespace Tests\Unit\Rewrite\Transformer\Delete;

use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\TestCase;
use ZtdQuery\Platform\MySql\Rewrite\Transformer\Delete\TargetProjection;
...
final class TargetProjectionTest extends TestCase
{
    ...
    {
        $target = new \ZtdQuery\Shadow\Mutation\Row\MultiTableMutationTarget('users', ['id', 'name'], ['id']);
        $codec = new \ZtdQuery\Shadow\Mutation\Row\MultiTableMutationRow();
