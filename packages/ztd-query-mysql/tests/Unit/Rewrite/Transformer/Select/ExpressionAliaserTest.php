...
use ZtdQuery\Platform\MySql\Rewrite\Transformer\Select\ExpressionAliaser;
...
final class ExpressionAliaserTest extends TestCase
{
    ...
    {
        $tokens = \ZtdQuery\Sql\SqlTokenStream::tokenize('FROM id', \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create())->significantTokens();
    ...
    {
        $tokens = \ZtdQuery\Sql\SqlTokenStream::tokenize('DISTINCT id', \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create())->significantTokens();
