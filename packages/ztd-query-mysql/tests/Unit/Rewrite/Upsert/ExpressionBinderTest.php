...
use ZtdQuery\Platform\MySql\Rewrite\Upsert\ExpressionBinder;
...
final class ExpressionBinderTest extends TestCase
{
    ...
    {
        $binder = new ExpressionBinder(new \ZtdQuery\Platform\MySql\Sql\MySqlIdentifierQuoter(), \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create());
    ...
    {
        $binder = new ExpressionBinder(new \ZtdQuery\Platform\MySql\Sql\MySqlIdentifierQuoter(), \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create());
        $tokens = \ZtdQuery\Sql\SqlTokenStream::tokenize('id + (SELECT score FROM t)', \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create())->significantTokens();
    ...
    {
        $binder = new ExpressionBinder(new \ZtdQuery\Platform\MySql\Sql\MySqlIdentifierQuoter(), \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create());
        $tokens = \ZtdQuery\Sql\SqlTokenStream::tokenize('score + 1', \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create())->significantTokens();
    ...
    {
        $binder = new ExpressionBinder(new \ZtdQuery\Platform\MySql\Sql\MySqlIdentifierQuoter(), \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create());
        $tokens = \ZtdQuery\Sql\SqlTokenStream::tokenize('VALUES(score)', \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create())->significantTokens();
        self::assertSame(['offset' => 0, 'length' => 13, 'value' => '`__ztd_incoming`.`score`', 'skip' => 7], $binder->incomingBinding($tokens, 0));
        self::assertNull($binder->incomingBinding(\ZtdQuery\Sql\SqlTokenStream::tokenize('VALUES(1 + 2)', \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create())->significantTokens(), 0));
    }

    public function testQualifiedBinding(): void
    {
        $binder = new ExpressionBinder(new \ZtdQuery\Platform\MySql\Sql\MySqlIdentifierQuoter(), \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create());
        $tokens = \ZtdQuery\Sql\SqlTokenStream::tokenize('t.score', \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create())->significantTokens();
