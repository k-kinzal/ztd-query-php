...
use ZtdQuery\Platform\MySql\Shadow\Mutation\Upsert\LiteralReader;
...
final class LiteralReaderTest extends TestCase
{
    public function testIdentifierPreservesWordsAndUnquotesNames(): void
    {
        ...
        $tokens = \ZtdQuery\Sql\SqlTokenStream::tokenize('score `a``b`', \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create())->significantTokens();
