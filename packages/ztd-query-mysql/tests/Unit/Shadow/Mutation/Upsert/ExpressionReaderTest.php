...
use ZtdQuery\Platform\MySql\Shadow\Mutation\Upsert\ExpressionReader;
...
final class ExpressionReaderTest extends TestCase
{
    ...
    {
        $tokens = \ZtdQuery\Sql\SqlTokenStream::tokenize('1 OR 0', \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create())->significantTokens();
        $index = 0;
    ...
    {
        $tokens = \ZtdQuery\Sql\SqlTokenStream::tokenize('1 AND 0', \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create())->significantTokens();
        $index = 0;
    ...
    {
        $tokens = \ZtdQuery\Sql\SqlTokenStream::tokenize('1 < 2', \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create())->significantTokens();
        $index = 0;
    ...
    {
        $tokens = \ZtdQuery\Sql\SqlTokenStream::tokenize('1 + 2 * 3', \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create())->significantTokens();
        $index = 0;
    ...
    {
        $tokens = \ZtdQuery\Sql\SqlTokenStream::tokenize('3 * 2', \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create())->significantTokens();
        $index = 0;
    ...
    {
        $tokens = \ZtdQuery\Sql\SqlTokenStream::tokenize('-2', \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create())->significantTokens();
        $index = 0;
    ...
    {
        $tokens = \ZtdQuery\Sql\SqlTokenStream::tokenize("'a''b'", \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create())->significantTokens();
        $index = 0;
    ...
    {
        $tokens = \ZtdQuery\Sql\SqlTokenStream::tokenize('users.score', \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create())->significantTokens();
        $index = 0;
    ...
    {
        $tokens = \ZtdQuery\Sql\SqlTokenStream::tokenize('(score)', \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create())->significantTokens();
        $index = 0;
    ...
    {
        $tokens = \ZtdQuery\Sql\SqlTokenStream::tokenize('!=', \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create())->significantTokens();
        $index = 0;
