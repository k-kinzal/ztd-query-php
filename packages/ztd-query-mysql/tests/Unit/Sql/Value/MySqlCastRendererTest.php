...
#[CoversClass(\ZtdQuery\Platform\MySql\Sql\Value\CastTypeResolver::class)]
...
final class MySqlCastRendererTest extends TestCase
{
    ...
    {
        self::assertSame("CAST('42' AS SIGNED)", (new MySqlCastRenderer())->renderCast("'42'", new ColumnDeclaration(ColumnTypeFamily::INTEGER, 'INT')));
    }

    public function testRenderNullCastProducesExactForm(): void
    {
        self::assertSame('CAST(NULL AS SIGNED)', (new MySqlCastRenderer())->renderNullCast(new ColumnDeclaration(ColumnTypeFamily::INTEGER, 'INT')));
    }

    public function testRenderCastForStringUsesCharType(): void
    {
        self::assertSame("CAST('hello' AS CHAR)", (new MySqlCastRenderer())->renderCast("'hello'", new ColumnDeclaration(ColumnTypeFamily::STRING, 'VARCHAR(255)')));
    }
}
