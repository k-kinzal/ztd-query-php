...
use ZtdQuery\Platform\MySql\Sql\Cte\HeaderParser;
...
final class HeaderParserTest extends TestCase
{
    ...
    {
        $reader = new HeaderParser(\ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create());
    ...
    {
        $reader = new HeaderParser(\ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create());
        self::assertSame(2, $reader->findAsIndex(\ZtdQuery\Sql\SqlTokenStream::tokenize('() AS', \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create())->significantTokens(), 0));
        self::assertNull($reader->findAsIndex(\ZtdQuery\Sql\SqlTokenStream::tokenize('other AS', \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create())->significantTokens(), 0));
    ...
    {
        $reader = new HeaderParser(\ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create());
        $tokens = \ZtdQuery\Sql\SqlTokenStream::tokenize('plain `a``b` ,', \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create())->significantTokens();
