...
use ZtdQuery\Platform\MySql\Sql\Relation\ReferenceReader;
...
final class ReferenceReaderTest extends TestCase
{
    ...
    {
        $tokens = \ZtdQuery\Sql\SqlTokenStream::tokenize('(users)', \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create())->significantTokens();
    ...
    public function testReferenceAt(): void
    {
        ...
        self::assertNull((new ReferenceReader())->referenceAt('SELECT', \ZtdQuery\Sql\SqlTokenStream::tokenize('SELECT', \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create())->significantTokens(), 0));
    }
    ...
    {
        $tokens = \ZtdQuery\Sql\SqlTokenStream::tokenize('ORDER BY id', \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create())->significantTokens();
        $reader = new ReferenceReader();
    ...
    public function testParenthesizedReferences(): void
    {
        ...
        self::assertSame([], (new ReferenceReader())->parenthesizedReferences($sql, \ZtdQuery\Sql\SqlTokenStream::tokenize($sql, \ZtdQuery\Platform\MySql\Sql\MySqlLexerProfile::create())->significantTokens(), 0));
    }
