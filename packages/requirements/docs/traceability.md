...
| Specification | A testable statement in EARS form, optionally linked to its tests. It can be `unsupported`, with a reason, when the project deliberately does not implement the source. |
