...
final class UpsertComparison
{
     ...
     */
    public function of(mixed $left, mixed $right): ?int
    {
     ...
     * @throws UnsupportedSqlException When one side is a number and the other is not
     */
    public function equal(mixed $left, mixed $right): ?bool
    {
     ...
     * @throws UnsupportedSqlException When one side is a number and the other is not
     */
    public function notEqual(mixed $left, mixed $right): ?bool
    {
        $order = $this->of($left, $right);
     ...
     * @throws UnsupportedSqlException When one side is a number and the other is not
     */
    public function less(mixed $left, mixed $right): ?bool
    {
        $order = $this->of($left, $right);
     ...
     * @throws UnsupportedSqlException When one side is a number and the other is not
     */
    public function lessOrEqual(mixed $left, mixed $right): ?bool
    {
        $order = $this->of($left, $right);
     ...
     * @throws UnsupportedSqlException When one side is a number and the other is not
     */
    public function greater(mixed $left, mixed $right): ?bool
    {
        $order = $this->of($left, $right);
     ...
     * @throws UnsupportedSqlException When one side is a number and the other is not
     */
    public function greaterOrEqual(mixed $left, mixed $right): ?bool
    {
        $order = $this->of($left, $right);
