...
use ZtdQuery\Shadow\Mutation\Upsert\UpsertLiteralSource;
...
final class UpsertExpression
{
     ...
     * @param UpsertLiteralSource $literal Value a literal stands for
    ...
    public function __construct(
        ...
        private readonly UpsertLiteralSource $literal = new UpsertLiteral(null),
     ...
     *
     * @param mixed $value Value as the statement wrote it
     *
     * @return self The expression
     */
    public static function literal(mixed $value): self
    {
        return new self(UpsertExpressionKind::Literal, literal: new UpsertLiteral($value));
    }
     ...
     *
     * @return mixed The value the expression stands for
     *
     ...
     * @param string $tableName Table being written to
     *
     * @return mixed The value that operand stands for
     *
     * @throws UnsupportedSqlException When an operand is not something the operator can be applied to
     */
