...
final class TableTransitions
{
     ...
     * @param array<int, Row> $beforeRows Its rows as they were
     * @param array<int, Row> $afterRows Its rows as they became
     * @param list<string> $primaryKeys Columns that identify one of its rows
     * @param array<int, Row> $identityRows Result rows carrying both the old key and the new one
     *
     ...
     * @param array<int, Row> $beforeRows Rows as they were
     * @param array<int, Row> $afterRows Rows as they became
     */
     ...
     *
     * @param array<int, Row> $rows Rows as they were
