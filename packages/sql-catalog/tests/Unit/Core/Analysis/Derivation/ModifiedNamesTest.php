...
final class ModifiedNamesTest extends TestCase
{
    ...
    public function testTracksObjectsRequiresAnExplicitEffectModel(): void
    {
        ...
        self::assertTrue((new ModifiedNames(objects: new \SqlCatalog\Core\Analysis\Derivation\Objects\ObjectEffects()))->tracksObjects());
    }    public function testOwnRetainsSymbolTableWritesAlongsideObjectEffects(): void
    {
        ...
        $modified = new ModifiedNames(objects: new \SqlCatalog\Core\Analysis\Derivation\Objects\ObjectEffects());
