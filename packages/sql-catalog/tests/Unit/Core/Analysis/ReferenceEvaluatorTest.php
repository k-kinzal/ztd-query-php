...
final class ReferenceEvaluatorTest extends TestCase
{
    ...
    public function testReadPropertyIsCalledWithTheExpressionItself(): void
    {
        ...
        $expressions = (new Interpreter($index, []))->evaluatorFor();
        $environment = new Environment(['c' => Domain::of(new \SqlCatalog\Core\Evaluation\ObjectTerm('C'))]);
    ...
    public function testReadEnumPropertyReadsTheCaseTheValueIs(): void
    {
        ...
        $read = $evaluator->readEnumProperty(Domain::of(new \SqlCatalog\Core\Evaluation\ObjectTerm('S', 'B')), 'S', 'value', new FunctionScope('t.php'), $expressions);
    ...
    public function testReadVariablePreservesProvenanceAndDomainFlagsWhileNamingOpaqueValues(): void
    {
        $value = Domain::fromTerms([
            ...
            new \SqlCatalog\Core\Evaluation\LiteralTerm('SELECT 1'),
        ], true, true);
