 ...
 *     $models = new \SqlCatalog\Core\Extension\Model\ModelSet(calls: [
 *         static fn (\SqlCatalog\Core\Extension\Model\CallContext $call): ?\SqlCatalog\Core\Evaluation\Domain =>
 *             $call->name === 'today_sql' ? \SqlCatalog\Core\Evaluation\Domain::literal('CURRENT_DATE') : null,
 *     ]);
