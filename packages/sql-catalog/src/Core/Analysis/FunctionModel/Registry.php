 ...
 *     $models->register('App\table', static fn (array $arguments) => \SqlCatalog\Core\Evaluation\Domain::literal('users'));
 *     $models->evaluate('App\table', [])?->soleLiteral()?->value // => 'users'
 *     $models->evaluate('strtoupper', [\SqlCatalog\Core\Evaluation\Domain::literal('users')])?->soleLiteral()?->value // => 'USERS'
 */
