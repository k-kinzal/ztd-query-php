...
final class EntryBinder
{
     ...
     *
     * A local with no reaching definition starts absent. Reading it yields null;
     * its existence remains separate from the values assigned later.
