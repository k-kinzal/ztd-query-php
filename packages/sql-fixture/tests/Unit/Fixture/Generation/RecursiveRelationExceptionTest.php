...
use SqlFixture\Fixture\Generation\RecursiveRelationException as Subject;
...
final class RecursiveRelationExceptionTest extends TestCase
{
    public function testShowsTheRepeatedTraversalPath(): void
    {
        self::assertSame('Recursive fixture traversal: posts -> comments -> posts. Multiple roles or shared rows require explicit references.', (new Subject(['posts', 'comments'], 'posts'))->getMessage());
    }
