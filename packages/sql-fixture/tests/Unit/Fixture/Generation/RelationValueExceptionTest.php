...
use SqlFixture\Fixture\Generation\RelationValueException as Subject;
...
final class RelationValueExceptionTest extends TestCase
{
    public function testNamesTheConflictingColumn(): void
    {
        self::assertSame('Conflicting relation values for comments.target_id. Related rows must use the same key.', (new Subject('comments', 'target_id'))->getMessage());
    }
