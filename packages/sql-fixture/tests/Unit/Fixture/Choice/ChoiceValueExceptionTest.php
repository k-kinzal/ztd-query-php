...
use SqlFixture\Fixture\Choice\ChoiceValueException as Subject;
...
final class ChoiceValueExceptionTest extends TestCase
{
    public function testReportsTheDiscriminatorAndReason(): void
    {
        self::assertSame('Cannot resolve choice on comments.kind: Unknown value.', (new Subject(ColumnRef::of('comments', 'kind'), 'Unknown value.'))->getMessage());
    }
