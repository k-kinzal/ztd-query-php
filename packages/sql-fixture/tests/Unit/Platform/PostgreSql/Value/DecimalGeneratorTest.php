...
use SqlFixture\Platform\PostgreSql\Value\DecimalGenerator as Subject;
...
final class DecimalGeneratorTest extends TestCase
{
    public function testGenerateDecimalHonorsScaleAndPrecision(): void
    {
        ...
        $value = $generator->generateDecimal($faker, new ColumnDefinition('price', 'DECIMAL', precision: 4, scale: 2));
        self::assertGreaterThanOrEqual(-99.99, $value);
