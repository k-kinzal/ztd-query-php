...
use SqlFixture\Plan\Choice\ChoiceDefinitionException as Subject;
...
final class ChoiceDefinitionExceptionTest extends TestCase
{
    public function testReportsTheDiscriminatorAndReason(): void
    {
        self::assertSame('Invalid choice on comments.kind: Duplicate value.', (new Subject(ColumnRef::of('comments', 'kind'), 'Duplicate value.'))->getMessage());
    }
