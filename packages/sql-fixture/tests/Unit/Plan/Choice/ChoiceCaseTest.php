...
use SqlFixture\Plan\Choice\ChoiceCase as Subject;
...
final class ChoiceCaseTest extends TestCase
{
    public function testPreservesAnEmptyBranchAndTypedValue(): void
    {
        $case = new Subject(false, []);
        self::assertFalse($case->value);
        self::assertSame([], $case->relations);
    }
