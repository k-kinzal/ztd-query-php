 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\AExprWithAExprCollateAnyName_8b12aefc $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
