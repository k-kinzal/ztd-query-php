 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\FuncExprCommonSubexprWithJsonObjectFuncArgList_3e678fa4 $value): string => \SqlSemantics\Statement\Writer::render($value);
