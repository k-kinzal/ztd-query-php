 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\CExprWithAExprOptIndirection_c21e64e8 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
