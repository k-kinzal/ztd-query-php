 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\DropStmtWithDropObjectTypeAnyNameAnyNameListOptDropBehavior_b25da0e2 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
