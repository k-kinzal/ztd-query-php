 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\AlterPublicationStmtWithAlterPublicationNameAddPPubObjList_96383067 $value): string => \SqlSemantics\Statement\Writer::render($value);
 *     $write instanceof \Closure // => true
 */
final class AlterPublicationStmtWithAlterPublicationNameAddPPubObjList_96383067 implements \SqlSemantics\Statement\Model\PostgreSql\Role\AlterPublicationStmtForm, \SqlSemantics\Statement\Model\PostgreSql\Role\ParseToplevelForm, \SqlSemantics\Statement\Model\PostgreSql\Role\RoutineBodyStmtForm, \SqlSemantics\Statement\Model\PostgreSql\Role\StmtForm, \SqlSemantics\Statement\Model\PostgreSql\Role\StmtmultiForm, \SqlSemantics\Statement\Model\PostgreSql\Role\ToplevelStmtForm, \SqlSemantics\Statement\Command
{
    ...
    {
        return new self($name, $this->pubObjList, $this->comments);
    }
    ...
    {
        return new self($this->name, $pubObjList, $this->comments);
    }
    ...
    {
        return new self($this->name, $this->pubObjList, $comments);
    }
}
