 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\AExprWithAExprIsUnicodeNormalFormNormalized_ce3efbcd $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
