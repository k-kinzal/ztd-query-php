 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\RenameStmtWithAlterTableIfPExistsRelationExprRenameOptColumnNameToName_9b9c4de8 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
