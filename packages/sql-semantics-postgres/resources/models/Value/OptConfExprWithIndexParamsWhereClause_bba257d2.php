...
final class OptConfExprWithIndexParamsWhereClause_bba257d2 implements \SqlSemantics\Statement\Model\PostgreSql\Role\OptConfExprForm
{
    ...
    {
        return new self($indexParams, $this->where, $this->comments);
    }
    ...
    {
        return new self($this->indexParams, $where, $this->comments);
    }
    ...
    {
        return new self($this->indexParams, $this->where, $comments);
    }
}
