 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\AExprWithAExprInPInExpr_03378548 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
