 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\RenameStmtWithAlterViewQualifiedNameRenameOptColumnNameToName_2a9f3e73 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
