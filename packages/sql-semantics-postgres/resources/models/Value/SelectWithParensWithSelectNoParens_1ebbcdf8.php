 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\SelectWithParensWithSelectNoParens_1ebbcdf8 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
