...
final class BExprWithBExprNotEqualsBExpr_976e0805 implements \SqlSemantics\Statement\Model\PostgreSql\Role\BExprForm
{
    ...
    {
        return new self($bExpr, $this->notEquals, $this->bExpr2, $this->comments);
    }
    ...
    {
        return new self($this->bExpr, $notEquals, $this->bExpr2, $this->comments);
    }
    ...
    {
        return new self($this->bExpr, $this->notEquals, $bExpr2, $this->comments);
    }
    ...
    {
        return new self($this->bExpr, $this->notEquals, $this->bExpr2, $comments);
    }
}
