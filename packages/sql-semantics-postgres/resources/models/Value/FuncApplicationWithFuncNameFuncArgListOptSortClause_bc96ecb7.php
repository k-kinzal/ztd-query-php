 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\FuncApplicationWithFuncNameFuncArgListOptSortClause_bc96ecb7 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
