...
final class PartitionCmdWithDetachPartitionQualifiedNameOptConcurrently_c41413df implements \SqlSemantics\Statement\Model\PostgreSql\Role\PartitionCmdForm
{
    ...
    {
        return new self($qualifiedName, $this->optConcurrently, $this->comments);
    }
    ...
    {
        return new self($this->qualifiedName, $optConcurrently, $this->comments);
    }
    ...
    {
        return new self($this->qualifiedName, $this->optConcurrently, $comments);
    }
}
