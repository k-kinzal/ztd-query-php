 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\DropStmtWithDropTypePIfPExistsTypeNameListOptDropBehavior_0036f1ba $value): string => \SqlSemantics\Statement\Writer::render($value);
 *     $write instanceof \Closure // => true
 */
final class DropStmtWithDropTypePIfPExistsTypeNameListOptDropBehavior_0036f1ba implements \SqlSemantics\Statement\Model\PostgreSql\Role\DropStmtForm, \SqlSemantics\Statement\Model\PostgreSql\Role\ParseToplevelForm, \SqlSemantics\Statement\Model\PostgreSql\Role\RoutineBodyStmtForm, \SqlSemantics\Statement\Model\PostgreSql\Role\StmtForm, \SqlSemantics\Statement\Model\PostgreSql\Role\StmtmultiForm, \SqlSemantics\Statement\Model\PostgreSql\Role\ToplevelStmtForm, \SqlSemantics\Statement\Command
{
    ...
    {
        return new self($typeNameList, $this->optDropBehavior, $this->comments);
    }
    ...
    {
        return new self($this->typeNameList, $optDropBehavior, $this->comments);
    }
    ...
    {
        return new self($this->typeNameList, $this->optDropBehavior, $comments);
    }
}
