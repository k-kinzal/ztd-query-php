...
final class SecLabelStmtWithSecurityLabelOptProviderOnColumnAnyNameIsSecurityLabel_3db00e0b implements \SqlSemantics\Statement\Model\PostgreSql\Role\SecLabelStmtForm, \SqlSemantics\Statement\Model\PostgreSql\Role\ParseToplevelForm, \SqlSemantics\Statement\Model\PostgreSql\Role\RoutineBodyStmtForm, \SqlSemantics\Statement\Model\PostgreSql\Role\StmtForm, \SqlSemantics\Statement\Model\PostgreSql\Role\StmtmultiForm, \SqlSemantics\Statement\Model\PostgreSql\Role\ToplevelStmtForm, \SqlSemantics\Statement\Command
{
    ...
    {
        return new self($optProvider, $this->anyName, $this->securityLabel, $this->comments);
    }
    ...
    {
        return new self($this->optProvider, $anyName, $this->securityLabel, $this->comments);
    }
    ...
    {
        return new self($this->optProvider, $this->anyName, $securityLabel, $this->comments);
    }
    ...
    {
        return new self($this->optProvider, $this->anyName, $this->securityLabel, $comments);
    }
}
