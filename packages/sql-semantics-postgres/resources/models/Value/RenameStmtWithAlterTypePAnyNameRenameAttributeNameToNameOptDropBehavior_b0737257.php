 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\RenameStmtWithAlterTypePAnyNameRenameAttributeNameToNameOptDropBehavior_b0737257 $value): string => \SqlSemantics\Statement\Writer::render($value);
...
final class RenameStmtWithAlterTypePAnyNameRenameAttributeNameToNameOptDropBehavior_b0737257 implements \SqlSemantics\Statement\Model\PostgreSql\Role\RenameStmtForm, \SqlSemantics\Statement\Model\PostgreSql\Role\ParseToplevelForm, \SqlSemantics\Statement\Model\PostgreSql\Role\RoutineBodyStmtForm, \SqlSemantics\Statement\Model\PostgreSql\Role\StmtForm, \SqlSemantics\Statement\Model\PostgreSql\Role\StmtmultiForm, \SqlSemantics\Statement\Model\PostgreSql\Role\ToplevelStmtForm, \SqlSemantics\Statement\Command
{
    ...
    {
        return new self($anyName, $this->name, $this->name2, $this->optDropBehavior, $this->comments);
    }
    ...
    {
        return new self($this->anyName, $name, $this->name2, $this->optDropBehavior, $this->comments);
    }
    ...
    {
        return new self($this->anyName, $this->name, $name2, $this->optDropBehavior, $this->comments);
    }
    ...
    {
        return new self($this->anyName, $this->name, $this->name2, $optDropBehavior, $this->comments);
    }
    ...
    {
        return new self($this->anyName, $this->name, $this->name2, $this->optDropBehavior, $comments);
    }
}
