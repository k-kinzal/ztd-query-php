...
final class AlterTableCmdWithAlterOptColumnColIdSetColumnStorage_9077d2df implements \SqlSemantics\Statement\Model\PostgreSql\Role\AlterTableCmdForm, \SqlSemantics\Statement\Model\PostgreSql\Role\AlterTableCmdsForm
{
    ...
    {
        return new self($optColumn, $this->colId, $this->columnStorage, $this->comments);
    }
    ...
    {
        return new self($this->optColumn, $colId, $this->columnStorage, $this->comments);
    }
    ...
    {
        return new self($this->optColumn, $this->colId, $columnStorage, $this->comments);
    }
    ...
    {
        return new self($this->optColumn, $this->colId, $this->columnStorage, $comments);
    }
}
