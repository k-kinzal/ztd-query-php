...
final class TypeListWithTypeListTypename_78334e11 implements \SqlSemantics\Statement\Model\PostgreSql\Role\TypeListForm
{
    ...
    {
        return new self($typeList, $this->typename, $this->comments);
    }
    ...
    {
        return new self($this->typeList, $typename, $this->comments);
    }
    ...
    {
        return new self($this->typeList, $this->typename, $comments);
    }
}
