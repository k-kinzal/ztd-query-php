...
final class TransactionModeListWithTransactionModeListTransactionModeItem_a4087b19 implements \SqlSemantics\Statement\Model\PostgreSql\Role\TransactionModeListForm, \SqlSemantics\Statement\Model\PostgreSql\Role\TransactionModeListOrEmptyForm
{
    ...
    {
        return new self($transactionModeList, $this->transactionModeItem, $this->comments);
    }
    ...
    {
        return new self($this->transactionModeList, $transactionModeItem, $this->comments);
    }
    ...
    {
        return new self($this->transactionModeList, $this->transactionModeItem, $comments);
    }
}
