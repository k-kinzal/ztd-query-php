 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\AlterTableCmdWithAlterOptColumnColIdResetReloptions_8fd8a9f5 $value): string => \SqlSemantics\Statement\Writer::render($value);
 *     $write instanceof \Closure // => true
 */
final class AlterTableCmdWithAlterOptColumnColIdResetReloptions_8fd8a9f5 implements \SqlSemantics\Statement\Model\PostgreSql\Role\AlterTableCmdForm, \SqlSemantics\Statement\Model\PostgreSql\Role\AlterTableCmdsForm
{
    ...
    {
        return new self($optColumn, $this->colId, $this->reloptions, $this->comments);
    }
    ...
    {
        return new self($this->optColumn, $colId, $this->reloptions, $this->comments);
    }
    ...
    {
        return new self($this->optColumn, $this->colId, $reloptions, $this->comments);
    }
    ...
    {
        return new self($this->optColumn, $this->colId, $this->reloptions, $comments);
    }
}
