 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\AExprWithAExprIsNotJsonPredicateTypeConstraintJsonKeyUniquenessConstraintOpt_1b6db014 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
