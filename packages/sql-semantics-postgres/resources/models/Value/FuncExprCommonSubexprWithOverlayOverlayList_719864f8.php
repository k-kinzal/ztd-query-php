 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\FuncExprCommonSubexprWithOverlayOverlayList_719864f8 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
