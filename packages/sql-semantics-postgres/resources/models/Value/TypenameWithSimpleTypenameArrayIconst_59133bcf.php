 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\TypenameWithSimpleTypenameArrayIconst_59133bcf $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
