...
final class SortbyWithAExprUsingQualAllOpOptNullsOrder_f10885c2 implements \SqlSemantics\Statement\Model\PostgreSql\Role\SortbyForm, \SqlSemantics\Statement\Model\PostgreSql\Role\SortbyListForm
{
    ...
    {
        return new self($aExpr, $this->qualAllOp, $this->optNullsOrder, $this->comments);
    }
    ...
    {
        return new self($this->aExpr, $qualAllOp, $this->optNullsOrder, $this->comments);
    }
    ...
    {
        return new self($this->aExpr, $this->qualAllOp, $optNullsOrder, $this->comments);
    }
    ...
    {
        return new self($this->aExpr, $this->qualAllOp, $this->optNullsOrder, $comments);
    }
}
