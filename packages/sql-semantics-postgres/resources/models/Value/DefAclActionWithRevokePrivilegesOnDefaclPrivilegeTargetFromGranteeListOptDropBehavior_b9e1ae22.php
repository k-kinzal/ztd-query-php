 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\DefAclActionWithRevokePrivilegesOnDefaclPrivilegeTargetFromGranteeListOptDropBehavior_b9e1ae22 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
