...
final class BExprWithBExprQualOpBExpr_b7fdc6b2 implements \SqlSemantics\Statement\Model\PostgreSql\Role\BExprForm
{
    ...
    {
        return new self($bExpr, $this->qualOp, $this->bExpr2, $this->comments);
    }
    ...
    {
        return new self($this->bExpr, $qualOp, $this->bExpr2, $this->comments);
    }
    ...
    {
        return new self($this->bExpr, $this->qualOp, $bExpr2, $this->comments);
    }
    ...
    {
        return new self($this->bExpr, $this->qualOp, $this->bExpr2, $comments);
    }
}
