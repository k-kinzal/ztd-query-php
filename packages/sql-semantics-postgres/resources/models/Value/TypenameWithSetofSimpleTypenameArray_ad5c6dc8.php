 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\TypenameWithSetofSimpleTypenameArray_ad5c6dc8 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
