 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\RevokeRoleStmtWithRevokePrivilegeListFromRoleListOptGrantedByOptDropBehavior_3eab653b $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
