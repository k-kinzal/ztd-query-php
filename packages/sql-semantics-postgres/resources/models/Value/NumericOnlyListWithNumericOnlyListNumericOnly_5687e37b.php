...
final class NumericOnlyListWithNumericOnlyListNumericOnly_5687e37b implements \SqlSemantics\Statement\Model\PostgreSql\Role\NumericOnlyListForm
{
    ...
    {
        return new self($numericOnlyList, $this->numericOnly, $this->comments);
    }
    ...
    {
        return new self($this->numericOnlyList, $numericOnly, $this->comments);
    }
    ...
    {
        return new self($this->numericOnlyList, $this->numericOnly, $comments);
    }
}
