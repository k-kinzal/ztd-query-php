 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\RenameStmtWithAlterForeignTableRelationExprRenameOptColumnNameToName_bf61fecf $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
