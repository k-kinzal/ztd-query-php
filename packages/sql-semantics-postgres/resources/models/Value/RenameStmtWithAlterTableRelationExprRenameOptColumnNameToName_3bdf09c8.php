 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\RenameStmtWithAlterTableRelationExprRenameOptColumnNameToName_3bdf09c8 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
