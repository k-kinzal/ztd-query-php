 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\SelectLimitWithOffsetClauseLimitClause_85283568 $value): string => \SqlSemantics\Statement\Writer::render($value);
...
final class SelectLimitWithOffsetClauseLimitClause_85283568 implements \SqlSemantics\Statement\Model\PostgreSql\Role\OptSelectLimitForm, \SqlSemantics\Statement\Model\PostgreSql\Role\SelectLimitForm
{
    ...
    {
        return new self($offsetClause, $this->limitClause, $this->comments);
    }
    ...
    {
        return new self($this->offsetClause, $limitClause, $this->comments);
    }
    ...
    {
        return new self($this->offsetClause, $this->limitClause, $comments);
    }
}
