 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\TypenameWithSimpleTypenameArray_12fe26d4 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
