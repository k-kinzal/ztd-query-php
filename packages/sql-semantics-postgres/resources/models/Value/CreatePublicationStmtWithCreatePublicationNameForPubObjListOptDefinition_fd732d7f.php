...
final class CreatePublicationStmtWithCreatePublicationNameForPubObjListOptDefinition_fd732d7f implements \SqlSemantics\Statement\Model\PostgreSql\Role\CreatePublicationStmtForm, \SqlSemantics\Statement\Model\PostgreSql\Role\ParseToplevelForm, \SqlSemantics\Statement\Model\PostgreSql\Role\RoutineBodyStmtForm, \SqlSemantics\Statement\Model\PostgreSql\Role\StmtForm, \SqlSemantics\Statement\Model\PostgreSql\Role\StmtmultiForm, \SqlSemantics\Statement\Model\PostgreSql\Role\ToplevelStmtForm, \SqlSemantics\Statement\Command
{
    ...
    {
        return new self($name, $this->pubObjList, $this->optDefinition, $this->comments);
    }
    ...
    {
        return new self($this->name, $pubObjList, $this->optDefinition, $this->comments);
    }
    ...
    {
        return new self($this->name, $this->pubObjList, $optDefinition, $this->comments);
    }
    ...
    {
        return new self($this->name, $this->pubObjList, $this->optDefinition, $comments);
    }
}
