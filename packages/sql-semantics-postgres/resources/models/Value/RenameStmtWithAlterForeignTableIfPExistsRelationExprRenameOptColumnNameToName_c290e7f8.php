 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\RenameStmtWithAlterForeignTableIfPExistsRelationExprRenameOptColumnNameToName_c290e7f8 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
