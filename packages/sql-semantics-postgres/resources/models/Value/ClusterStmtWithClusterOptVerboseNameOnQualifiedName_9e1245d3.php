 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\ClusterStmtWithClusterOptVerboseNameOnQualifiedName_9e1245d3 $value): string => \SqlSemantics\Statement\Writer::render($value);
