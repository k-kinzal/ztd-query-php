 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\AExprWithAExprIsJsonPredicateTypeConstraintJsonKeyUniquenessConstraintOpt_25f5c4f8 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
