 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\VariableShowStmtWithShowVarName_8a5e8bd0 $value): string => \SqlSemantics\Statement\Writer::render($value);
