 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\CExprWithSelectWithParensIndirection_96244bc5 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
