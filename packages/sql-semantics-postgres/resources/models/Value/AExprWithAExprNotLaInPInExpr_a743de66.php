 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\AExprWithAExprNotLaInPInExpr_a743de66 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
