 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\FuncArgWithArgClassParamNameFuncType_32a02f12 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
