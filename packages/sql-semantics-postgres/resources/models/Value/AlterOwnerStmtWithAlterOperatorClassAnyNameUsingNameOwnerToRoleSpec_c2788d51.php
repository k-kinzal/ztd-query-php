 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\AlterOwnerStmtWithAlterOperatorClassAnyNameUsingNameOwnerToRoleSpec_c2788d51 $value): string => \SqlSemantics\Statement\Writer::render($value);
...
final class AlterOwnerStmtWithAlterOperatorClassAnyNameUsingNameOwnerToRoleSpec_c2788d51 implements \SqlSemantics\Statement\Model\PostgreSql\Role\AlterOwnerStmtForm, \SqlSemantics\Statement\Model\PostgreSql\Role\ParseToplevelForm, \SqlSemantics\Statement\Model\PostgreSql\Role\RoutineBodyStmtForm, \SqlSemantics\Statement\Model\PostgreSql\Role\StmtForm, \SqlSemantics\Statement\Model\PostgreSql\Role\StmtmultiForm, \SqlSemantics\Statement\Model\PostgreSql\Role\ToplevelStmtForm, \SqlSemantics\Statement\Command
{
    ...
    {
        return new self($anyName, $this->name, $this->roleSpec, $this->comments);
    }
    ...
    {
        return new self($this->anyName, $name, $this->roleSpec, $this->comments);
    }
    ...
    {
        return new self($this->anyName, $this->name, $roleSpec, $this->comments);
    }
    ...
    {
        return new self($this->anyName, $this->name, $this->roleSpec, $comments);
    }
}
