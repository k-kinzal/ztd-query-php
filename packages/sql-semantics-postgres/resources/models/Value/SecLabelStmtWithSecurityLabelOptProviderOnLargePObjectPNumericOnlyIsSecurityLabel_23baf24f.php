 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\SecLabelStmtWithSecurityLabelOptProviderOnLargePObjectPNumericOnlyIsSecurityLabel_23baf24f $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
