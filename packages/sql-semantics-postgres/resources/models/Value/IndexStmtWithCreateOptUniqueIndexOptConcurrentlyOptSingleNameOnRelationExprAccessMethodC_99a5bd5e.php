...
final class IndexStmtWithCreateOptUniqueIndexOptConcurrentlyOptSingleNameOnRelationExprAccessMethodC_99a5bd5e implements \SqlSemantics\Statement\Model\PostgreSql\Role\IndexStmtForm, \SqlSemantics\Statement\Model\PostgreSql\Role\ParseToplevelForm, \SqlSemantics\Statement\Model\PostgreSql\Role\RoutineBodyStmtForm, \SqlSemantics\Statement\Model\PostgreSql\Role\SchemaStmtForm, \SqlSemantics\Statement\Model\PostgreSql\Role\StmtForm, \SqlSemantics\Statement\Model\PostgreSql\Role\StmtmultiForm, \SqlSemantics\Statement\Model\PostgreSql\Role\ToplevelStmtForm, \SqlSemantics\Statement\Command
{
    ...
    {
        return new self($optUnique, $this->optConcurrently, $this->optSingleName, $this->relationExpr, $this->accessMethodClause, $this->indexParams, $this->optInclude, $this->optUniqueNullTreatment, $this->optReloptions, $this->optTableSpace, $this->where);
    }
    ...
    {
        return new self($this->optUnique, $optConcurrently, $this->optSingleName, $this->relationExpr, $this->accessMethodClause, $this->indexParams, $this->optInclude, $this->optUniqueNullTreatment, $this->optReloptions, $this->optTableSpace, $this->where);
    }
    ...
    {
        return new self($this->optUnique, $this->optConcurrently, $optSingleName, $this->relationExpr, $this->accessMethodClause, $this->indexParams, $this->optInclude, $this->optUniqueNullTreatment, $this->optReloptions, $this->optTableSpace, $this->where);
    }
    ...
    {
        return new self($this->optUnique, $this->optConcurrently, $this->optSingleName, $relationExpr, $this->accessMethodClause, $this->indexParams, $this->optInclude, $this->optUniqueNullTreatment, $this->optReloptions, $this->optTableSpace, $this->where);
    }
    ...
    {
        return new self($this->optUnique, $this->optConcurrently, $this->optSingleName, $this->relationExpr, $accessMethodClause, $this->indexParams, $this->optInclude, $this->optUniqueNullTreatment, $this->optReloptions, $this->optTableSpace, $this->where);
    }
    ...
    {
        return new self($this->optUnique, $this->optConcurrently, $this->optSingleName, $this->relationExpr, $this->accessMethodClause, $indexParams, $this->optInclude, $this->optUniqueNullTreatment, $this->optReloptions, $this->optTableSpace, $this->where);
    }
    ...
    {
        return new self($this->optUnique, $this->optConcurrently, $this->optSingleName, $this->relationExpr, $this->accessMethodClause, $this->indexParams, $optInclude, $this->optUniqueNullTreatment, $this->optReloptions, $this->optTableSpace, $this->where);
    }
    ...
    {
        return new self($this->optUnique, $this->optConcurrently, $this->optSingleName, $this->relationExpr, $this->accessMethodClause, $this->indexParams, $this->optInclude, $optUniqueNullTreatment, $this->optReloptions, $this->optTableSpace, $this->where);
    }
    ...
    {
        return new self($this->optUnique, $this->optConcurrently, $this->optSingleName, $this->relationExpr, $this->accessMethodClause, $this->indexParams, $this->optInclude, $this->optUniqueNullTreatment, $optReloptions, $this->optTableSpace, $this->where);
    }
    ...
    {
        return new self($this->optUnique, $this->optConcurrently, $this->optSingleName, $this->relationExpr, $this->accessMethodClause, $this->indexParams, $this->optInclude, $this->optUniqueNullTreatment, $this->optReloptions, $optTableSpace, $this->where);
    }
    ...
    {
        return new self($this->optUnique, $this->optConcurrently, $this->optSingleName, $this->relationExpr, $this->accessMethodClause, $this->indexParams, $this->optInclude, $this->optUniqueNullTreatment, $this->optReloptions, $this->optTableSpace, $where);
    }
}
