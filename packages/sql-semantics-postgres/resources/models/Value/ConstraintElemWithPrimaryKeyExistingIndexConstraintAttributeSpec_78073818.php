 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\ConstraintElemWithPrimaryKeyExistingIndexConstraintAttributeSpec_78073818 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
