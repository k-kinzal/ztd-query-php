 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\FuncExprCommonSubexprWithLocaltimestamp_9be85384 $value): string => \SqlSemantics\Statement\Writer::render($value);
