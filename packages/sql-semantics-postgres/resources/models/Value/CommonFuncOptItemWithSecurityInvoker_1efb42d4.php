 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\CommonFuncOptItemWithSecurityInvoker_1efb42d4 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
