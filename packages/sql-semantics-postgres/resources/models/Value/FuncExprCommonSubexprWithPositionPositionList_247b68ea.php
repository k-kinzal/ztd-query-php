 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\FuncExprCommonSubexprWithPositionPositionList_247b68ea $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
