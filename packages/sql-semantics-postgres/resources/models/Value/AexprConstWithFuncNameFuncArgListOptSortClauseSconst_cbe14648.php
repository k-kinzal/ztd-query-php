 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\AexprConstWithFuncNameFuncArgListOptSortClauseSconst_cbe14648 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
