...
final class TypedTableElementListWithTypedTableElementListTypedTableElement_4e3b2727 implements \SqlSemantics\Statement\Model\PostgreSql\Role\TypedTableElementListForm
{
    ...
    {
        return new self($typedTableElementList, $this->typedTableElement, $this->comments);
    }
    ...
    {
        return new self($this->typedTableElementList, $typedTableElement, $this->comments);
    }
    ...
    {
        return new self($this->typedTableElementList, $this->typedTableElement, $comments);
    }
}
