 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\CommentStmtWithCommentOnOperatorFamilyAnyNameUsingNameIsCommentText_7797791c $value): string => \SqlSemantics\Statement\Writer::render($value);
 *     $write instanceof \Closure // => true
 */
final class CommentStmtWithCommentOnOperatorFamilyAnyNameUsingNameIsCommentText_7797791c implements \SqlSemantics\Statement\Model\PostgreSql\Role\CommentStmtForm, \SqlSemantics\Statement\Model\PostgreSql\Role\ParseToplevelForm, \SqlSemantics\Statement\Model\PostgreSql\Role\RoutineBodyStmtForm, \SqlSemantics\Statement\Model\PostgreSql\Role\StmtForm, \SqlSemantics\Statement\Model\PostgreSql\Role\StmtmultiForm, \SqlSemantics\Statement\Model\PostgreSql\Role\ToplevelStmtForm, \SqlSemantics\Statement\Command
{
    ...
    {
        return new self($anyName, $this->name, $this->commentText, $this->comments);
    }
    ...
    {
        return new self($this->anyName, $name, $this->commentText, $this->comments);
    }
    ...
    {
        return new self($this->anyName, $this->name, $commentText, $this->comments);
    }
    ...
    {
        return new self($this->anyName, $this->name, $this->commentText, $comments);
    }
}
