 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\DropStmtWithDropObjectTypeNameOnAnyNameIfPExistsNameOnAnyNameOptDropBehavior_4528d3dd $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
