 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\AlterOwnerStmtWithAlterTextPSearchConfigurationAnyNameOwnerToRoleSpec_44932e8f $value): string => \SqlSemantics\Statement\Writer::render($value);
 *     $write instanceof \Closure // => true
 */
final class AlterOwnerStmtWithAlterTextPSearchConfigurationAnyNameOwnerToRoleSpec_44932e8f implements \SqlSemantics\Statement\Model\PostgreSql\Role\AlterOwnerStmtForm, \SqlSemantics\Statement\Model\PostgreSql\Role\ParseToplevelForm, \SqlSemantics\Statement\Model\PostgreSql\Role\RoutineBodyStmtForm, \SqlSemantics\Statement\Model\PostgreSql\Role\StmtForm, \SqlSemantics\Statement\Model\PostgreSql\Role\StmtmultiForm, \SqlSemantics\Statement\Model\PostgreSql\Role\ToplevelStmtForm, \SqlSemantics\Statement\Command
{
    ...
    {
        return new self($anyName, $this->roleSpec, $this->comments);
    }
    ...
    {
        return new self($this->anyName, $roleSpec, $this->comments);
    }
    ...
    {
        return new self($this->anyName, $this->roleSpec, $comments);
    }
}
