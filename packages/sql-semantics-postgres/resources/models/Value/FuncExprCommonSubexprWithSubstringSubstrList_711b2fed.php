 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\FuncExprCommonSubexprWithSubstringSubstrList_711b2fed $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
