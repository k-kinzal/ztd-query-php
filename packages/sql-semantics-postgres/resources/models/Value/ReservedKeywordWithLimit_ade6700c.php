 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\ReservedKeywordWithLimit_ade6700c $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
