 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\ImplicitRowWithExprListAExpr_27ad717c $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
