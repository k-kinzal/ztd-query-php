 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\FuncApplicationWithFuncNameAllFuncArgListOptSortClause_21b799a2 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
