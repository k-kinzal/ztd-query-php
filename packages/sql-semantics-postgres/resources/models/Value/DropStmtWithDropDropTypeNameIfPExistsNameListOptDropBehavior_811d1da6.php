 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\DropStmtWithDropDropTypeNameIfPExistsNameListOptDropBehavior_811d1da6 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
