...
final class RenameStmtWithAlterTableIfPExistsRelationExprRenameConstraintNameToName_63ec6d03 implements \SqlSemantics\Statement\Model\PostgreSql\Role\RenameStmtForm, \SqlSemantics\Statement\Model\PostgreSql\Role\ParseToplevelForm, \SqlSemantics\Statement\Model\PostgreSql\Role\RoutineBodyStmtForm, \SqlSemantics\Statement\Model\PostgreSql\Role\StmtForm, \SqlSemantics\Statement\Model\PostgreSql\Role\StmtmultiForm, \SqlSemantics\Statement\Model\PostgreSql\Role\ToplevelStmtForm, \SqlSemantics\Statement\Command
{
    ...
    {
        return new self($relationExpr, $this->name, $this->name2, $this->comments);
    }
    ...
    {
        return new self($this->relationExpr, $name, $this->name2, $this->comments);
    }
    ...
    {
        return new self($this->relationExpr, $this->name, $name2, $this->comments);
    }
    ...
    {
        return new self($this->relationExpr, $this->name, $this->name2, $comments);
    }
}
