 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\ReservedKeywordWithSessionUser_3325ac4f $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
