 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\CommentStmtWithCommentOnColumnAnyNameIsCommentText_1db3a4f3 $value): string => \SqlSemantics\Statement\Writer::render($value);
 *     $write instanceof \Closure // => true
 */
final class CommentStmtWithCommentOnColumnAnyNameIsCommentText_1db3a4f3 implements \SqlSemantics\Statement\Model\PostgreSql\Role\CommentStmtForm, \SqlSemantics\Statement\Model\PostgreSql\Role\ParseToplevelForm, \SqlSemantics\Statement\Model\PostgreSql\Role\RoutineBodyStmtForm, \SqlSemantics\Statement\Model\PostgreSql\Role\StmtForm, \SqlSemantics\Statement\Model\PostgreSql\Role\StmtmultiForm, \SqlSemantics\Statement\Model\PostgreSql\Role\ToplevelStmtForm, \SqlSemantics\Statement\Command
{
    ...
    {
        return new self($anyName, $this->commentText, $this->comments);
    }
    ...
    {
        return new self($this->anyName, $commentText, $this->comments);
    }
    ...
    {
        return new self($this->anyName, $this->commentText, $comments);
    }
}
