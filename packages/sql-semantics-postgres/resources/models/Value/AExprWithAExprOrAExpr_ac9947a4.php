 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\AExprWithAExprOrAExpr_ac9947a4 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
