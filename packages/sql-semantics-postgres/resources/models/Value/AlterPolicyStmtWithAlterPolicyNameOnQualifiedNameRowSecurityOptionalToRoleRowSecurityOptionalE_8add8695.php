...
final class AlterPolicyStmtWithAlterPolicyNameOnQualifiedNameRowSecurityOptionalToRoleRowSecurityOptionalE_8add8695 implements \SqlSemantics\Statement\Model\PostgreSql\Role\AlterPolicyStmtForm, \SqlSemantics\Statement\Model\PostgreSql\Role\ParseToplevelForm, \SqlSemantics\Statement\Model\PostgreSql\Role\RoutineBodyStmtForm, \SqlSemantics\Statement\Model\PostgreSql\Role\StmtForm, \SqlSemantics\Statement\Model\PostgreSql\Role\StmtmultiForm, \SqlSemantics\Statement\Model\PostgreSql\Role\ToplevelStmtForm, \SqlSemantics\Statement\Command
{
    ...
    {
        return new self($name, $this->qualifiedName, $this->rowSecurityOptionalToRole, $this->rowSecurityOptionalExpr, $this->rowSecurityOptionalWithCheck, $this->comments);
    }
    ...
    {
        return new self($this->name, $qualifiedName, $this->rowSecurityOptionalToRole, $this->rowSecurityOptionalExpr, $this->rowSecurityOptionalWithCheck, $this->comments);
    }
    ...
    {
        return new self($this->name, $this->qualifiedName, $rowSecurityOptionalToRole, $this->rowSecurityOptionalExpr, $this->rowSecurityOptionalWithCheck, $this->comments);
    }
    ...
    {
        return new self($this->name, $this->qualifiedName, $this->rowSecurityOptionalToRole, $rowSecurityOptionalExpr, $this->rowSecurityOptionalWithCheck, $this->comments);
    }
    ...
    {
        return new self($this->name, $this->qualifiedName, $this->rowSecurityOptionalToRole, $this->rowSecurityOptionalExpr, $rowSecurityOptionalWithCheck, $this->comments);
    }
    ...
    {
        return new self($this->name, $this->qualifiedName, $this->rowSecurityOptionalToRole, $this->rowSecurityOptionalExpr, $this->rowSecurityOptionalWithCheck, $comments);
    }
}
