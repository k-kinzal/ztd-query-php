...
final class SeqOptElemWithRestartOptWithNumericOnly_5612e55b implements \SqlSemantics\Statement\Model\PostgreSql\Role\OptSeqOptListForm, \SqlSemantics\Statement\Model\PostgreSql\Role\SeqOptElemForm, \SqlSemantics\Statement\Model\PostgreSql\Role\SeqOptListForm
{
    ...
    {
        return new self($optWith, $this->numericOnly, $this->comments);
    }
    ...
    {
        return new self($this->optWith, $numericOnly, $this->comments);
    }
    ...
    {
        return new self($this->optWith, $this->numericOnly, $comments);
    }
}
