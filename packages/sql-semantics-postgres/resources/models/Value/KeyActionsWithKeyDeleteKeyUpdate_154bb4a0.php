...
final class KeyActionsWithKeyDeleteKeyUpdate_154bb4a0 implements \SqlSemantics\Statement\Model\PostgreSql\Role\KeyActionsForm
{
    ...
    {
        return new self($keyDelete, $this->keyUpdate, $this->comments);
    }
    ...
    {
        return new self($this->keyDelete, $keyUpdate, $this->comments);
    }
    ...
    {
        return new self($this->keyDelete, $this->keyUpdate, $comments);
    }
}
