...
final class FromListWithFromListTableRef_1cc17d12 implements \SqlSemantics\Statement\Model\PostgreSql\Role\FromListForm
{
    ...
    {
        return new self($fromList, $this->tableRef, $this->comments);
    }
    ...
    {
        return new self($this->fromList, $tableRef, $this->comments);
    }
    ...
    {
        return new self($this->fromList, $this->tableRef, $comments);
    }
}
