 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\Sqlite\Value\ExprWithRaiseLpIgnoreRp_ccfbbaf2 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
