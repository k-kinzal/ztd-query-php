 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\TypeFuncNameKeywordWithBinary_c4fb105f $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
