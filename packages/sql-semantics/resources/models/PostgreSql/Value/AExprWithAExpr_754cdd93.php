 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\AExprWithAExpr_754cdd93 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
