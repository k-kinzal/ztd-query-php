 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\CreateTrigStmtWithCreateOptOrReplaceConstraintTriggerNameAfterTriggerEventsOnQualifiedNameOpt_0a3387e3 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
