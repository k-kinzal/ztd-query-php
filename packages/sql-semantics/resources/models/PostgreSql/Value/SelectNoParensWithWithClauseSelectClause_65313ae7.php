 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\SelectNoParensWithWithClauseSelectClause_65313ae7 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
