 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\ReservedKeywordWithAsc_56de4e9e $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
