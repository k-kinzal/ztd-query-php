 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\PostgreSql\Value\AExprWithAExprLessEqualsAExpr_84fef888 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
