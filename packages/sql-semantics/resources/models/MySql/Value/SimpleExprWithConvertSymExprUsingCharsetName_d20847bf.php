 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\SimpleExprWithConvertSymExprUsingCharsetName_d20847bf $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
