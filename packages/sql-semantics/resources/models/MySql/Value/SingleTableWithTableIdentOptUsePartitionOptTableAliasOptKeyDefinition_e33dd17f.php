 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\SingleTableWithTableIdentOptUsePartitionOptTableAliasOptKeyDefinition_e33dd17f $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
