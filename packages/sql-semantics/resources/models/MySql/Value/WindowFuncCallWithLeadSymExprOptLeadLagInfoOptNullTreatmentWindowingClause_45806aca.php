 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\WindowFuncCallWithLeadSymExprOptLeadLagInfoOptNullTreatmentWindowingClause_45806aca $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
