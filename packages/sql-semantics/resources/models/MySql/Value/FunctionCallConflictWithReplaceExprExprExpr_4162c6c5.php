 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\FunctionCallConflictWithReplaceExprExprExpr_4162c6c5 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
