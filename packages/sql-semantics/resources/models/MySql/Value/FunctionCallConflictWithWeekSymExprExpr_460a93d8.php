 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\FunctionCallConflictWithWeekSymExprExpr_460a93d8 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
