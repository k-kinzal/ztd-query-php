 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\InsertStmtWithInsertInsertLockOptionOptIgnoreOptIntoTableIdentOptUsePartitionSetUpdateLis_5b98c690 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
