 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\CreateTableOptionWithStatsPersistentSymOptEqualUlongNum_e45118b9 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
