 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\StandaloneAlterCommandsWithOptimizePartitionSymOptNoWriteToBinlogAllOrAltPartNameList_492888d5 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
