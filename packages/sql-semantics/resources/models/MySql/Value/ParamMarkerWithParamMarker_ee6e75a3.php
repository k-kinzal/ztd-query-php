 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\ParamMarkerWithParamMarker_ee6e75a3 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
