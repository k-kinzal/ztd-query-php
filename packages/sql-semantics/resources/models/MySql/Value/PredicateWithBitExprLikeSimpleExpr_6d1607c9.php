 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\PredicateWithBitExprLikeSimpleExpr_6d1607c9 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
