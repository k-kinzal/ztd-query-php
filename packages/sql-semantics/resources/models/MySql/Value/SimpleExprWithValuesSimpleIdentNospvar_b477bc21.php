 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\SimpleExprWithValuesSimpleIdentNospvar_b477bc21 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
