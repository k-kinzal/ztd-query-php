 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\QueryExpressionParensWithQueryExpressionParens_830c0f99 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
