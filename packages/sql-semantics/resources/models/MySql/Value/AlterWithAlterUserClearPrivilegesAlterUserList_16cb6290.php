 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\AlterWithAlterUserClearPrivilegesAlterUserList_16cb6290 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
