 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\StandaloneAlterCommandsWithRebuildSymPartitionSymOptNoWriteToBinlogAllOrAltPartNameList_a531ae19 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
