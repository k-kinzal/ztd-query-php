 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\BitExprWithBitExprBitExpr_18836827 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
