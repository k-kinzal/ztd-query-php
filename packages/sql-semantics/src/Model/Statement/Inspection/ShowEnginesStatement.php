...
/**
 * Requests available storage engines and their capabilities.
 * @visibility public
 * @example Inspecting the result roles
 *     $statement = (new \SqlSemantics\Binder((new \SqlSemantics\SchemaBuilder(\SqlSemantics\Dialect::MySql))->build()))->bind('SHOW ENGINES');
 *     $statement instanceof \SqlSemantics\Model\Statement\Inspection\ShowEnginesStatement // => true
 */
final class ShowEnginesStatement extends BoundStatement implements ResultStatement
{
    /**
    ...
    {
        $columns = [];
        foreach (EngineField::cases() as $ordinal => $field) {
