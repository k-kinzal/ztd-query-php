...
/**
 * Lists triggers of a database.
 * @visibility public
 * @example Inspecting the listed database
 *     $statement = (new \SqlSemantics\Binder((new \SqlSemantics\SchemaBuilder(\SqlSemantics\Dialect::MySql))->build()))->bind("SHOW TRIGGERS IN app WHERE `Table` = 'users'");
 *     $statement->database // => 'app'
 */
final class ShowTriggersStatement extends InspectionStatement
{
    /**
    ...
    {
        return $this->columns(TriggerField::cases());
    }
}
