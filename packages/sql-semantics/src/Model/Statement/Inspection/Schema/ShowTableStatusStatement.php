...
/**
 * Reports storage facts for each table of a database.
 * @visibility public
 * @example Inspecting the listed database
 *     $statement = (new \SqlSemantics\Binder((new \SqlSemantics\SchemaBuilder(\SqlSemantics\Dialect::MySql))->build()))->bind("SHOW TABLE STATUS FROM app LIKE 'user%'");
 *     $statement->database // => 'app'
 */
final class ShowTableStatusStatement extends InspectionStatement
{
    /**
    ...
    {
        return $this->columns(TableStatusField::cases());
    }
}
