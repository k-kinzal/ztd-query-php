...
/**
 * Lists tables currently open in the table cache.
 * @visibility public
 * @example Inspecting the listed database
 *     $statement = (new \SqlSemantics\Binder((new \SqlSemantics\SchemaBuilder(\SqlSemantics\Dialect::MySql))->build()))->bind("SHOW OPEN TABLES IN app WHERE In_use > 0");
 *     $statement->database // => 'app'
 */
final class ShowOpenTablesStatement extends InspectionStatement
{
    /**
    ...
    {
        return $this->columns(OpenTableField::cases());
    }
}
