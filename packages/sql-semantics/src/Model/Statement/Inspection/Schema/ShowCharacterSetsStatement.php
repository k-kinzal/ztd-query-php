 ...
 *     $statement = (new \SqlSemantics\Binder((new \SqlSemantics\SchemaBuilder(\SqlSemantics\Dialect::MySql))->build()))->bind("SHOW CHARACTER SET LIKE 'utf8%'");
 *     $statement->filter instanceof \SqlSemantics\Model\Query\Inspection\Filter\PatternFilter // => true
 */
final class ShowCharacterSetsStatement extends InspectionStatement
{
    /**
    ...
    {
        return $this->columns(CharacterSetField::cases());
    }
}
