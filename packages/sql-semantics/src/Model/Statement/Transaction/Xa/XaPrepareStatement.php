...
/**
 * Requests preparation of one required XA transaction branch.
 * @visibility public
 * @example Binding the operation
 *     $statement = (new \SqlSemantics\Binder((new \SqlSemantics\SchemaBuilder(\SqlSemantics\Dialect::MySql))->build()))->bind("XA PREPARE 'global'");
 *     $statement instanceof \SqlSemantics\Model\Statement\Transaction\Xa\XaPrepareStatement // => true
 */
final class XaPrepareStatement extends BoundStatement
{
    /**
    ...
    {
        return StatementKind::XaPrepare;
    }
