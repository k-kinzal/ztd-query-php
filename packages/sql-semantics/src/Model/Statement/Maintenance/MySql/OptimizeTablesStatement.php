...
/**
 * Requests physical optimization of the named tables.
 * @visibility public
 * @example Inspecting the affected tables
 *     $schema = (new \SqlSemantics\SchemaBuilder(\SqlSemantics\Dialect::MySql))->build('CREATE TABLE t(id INT)');
 *     $statement = (new \SqlSemantics\Binder($schema))->bind('OPTIMIZE LOCAL TABLE t');
 *     $statement->tables[0]->declaration->name // => 't'
 */
final class OptimizeTablesStatement extends BoundStatement implements ResultStatement
{
    /**
