...
final class DropIndexStatement extends \SqlSemantics\Model\BoundStatement
{
    ...
    public function __construct(
        ...
        if ($origin->dialect === \SqlSemantics\Dialect::MySql || $origin->dialect === \SqlSemantics\Dialect::Sqlite && (count($names) !== 1 || $behavior !== \SqlSemantics\Model\Definition\DropBehavior::Default)) {
            throw new \SqlSemantics\Model\Validation\InvalidStructure('This index deletion form does not match the database language.');
        }
