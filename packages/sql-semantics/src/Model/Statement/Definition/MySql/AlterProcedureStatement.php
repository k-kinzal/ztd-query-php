...
/**
 * Changes stored PROCEDURE characteristics without changing its body or executing it.
 * @visibility public
 * @example Inspecting the routine target
 *     $statement = (new \SqlSemantics\Binder((new \SqlSemantics\SchemaBuilder(\SqlSemantics\Dialect::MySql))->build()))->bind('ALTER PROCEDURE app.r NO SQL');
 *     $statement->name->parts // => ['app', 'r']
 */
final class AlterProcedureStatement extends BoundStatement
{
    /**
