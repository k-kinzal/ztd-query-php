...
/**
 * Deletes one MySQL function selected by name, without an overload signature.
 * @visibility public
 * @example Inspecting a named deletion
 *     $statement = (new \SqlSemantics\Binder((new \SqlSemantics\SchemaBuilder(\SqlSemantics\Dialect::MySql))->build()))->bind('DROP FUNCTION app.f');
 *     $statement->name->parts // => ['app', 'f']
 */
final class DropFunctionStatement extends BoundStatement
{
    /**
