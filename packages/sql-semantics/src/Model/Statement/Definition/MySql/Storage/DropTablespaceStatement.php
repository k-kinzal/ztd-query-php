...
/**
 * Requests DROP TABLESPACE without deleting any physical storage.
 * @visibility public
 * @example Inspecting the storage identity
 *     $statement = (new \SqlSemantics\Binder((new \SqlSemantics\SchemaBuilder(\SqlSemantics\Dialect::MySql))->build()))->bind('DROP TABLESPACE store');
