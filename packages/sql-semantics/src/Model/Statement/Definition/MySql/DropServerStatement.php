...
/**
 * Describes removal of one named MySQL server without executing it.
 * @visibility public
 * @example Inspecting the deletion target
 *     $statement = (new \SqlSemantics\Binder((new \SqlSemantics\SchemaBuilder(\SqlSemantics\Dialect::MySql))->build()))->bind('DROP SERVER target');
 *     $statement->name // => 'target'
 */
final class DropServerStatement extends BoundStatement
{
    /**
