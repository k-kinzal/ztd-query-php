...
/**
 * Requests removal of named foreign-data wrappers and records dependent-object behavior.
 * @visibility public
 * @example Inspecting all removal targets
 *     $statement = (new \SqlSemantics\Binder((new \SqlSemantics\SchemaBuilder(\SqlSemantics\Dialect::PostgreSql))->build()))->bind('DROP FOREIGN DATA WRAPPER one, two CASCADE');
 ...
 *     new \SqlSemantics\Model\Statement\Definition\PostgreSql\DropForeignDataWrappersStatement($origin, []); // throws \SqlSemantics\Model\Validation\InvalidStructure
 */
final class DropForeignDataWrappersStatement extends BoundStatement
{
    /**
