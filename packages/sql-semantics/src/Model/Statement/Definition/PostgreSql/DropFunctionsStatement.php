...
/**
 * Deletes function definitions identified by their typed names and argument requests.
 * @visibility public
 * @example Inspecting a deletion request
 *     $statement = (new \SqlSemantics\Binder((new \SqlSemantics\SchemaBuilder(\SqlSemantics\Dialect::PostgreSql))->build()))->bind('DROP FUNCTION f()');
 *     $statement instanceof \SqlSemantics\Model\Statement\Definition\PostgreSql\DropFunctionsStatement // => true
 ...
 *     new \SqlSemantics\Model\Statement\Definition\PostgreSql\DropFunctionsStatement($origin, []); // throws \SqlSemantics\Model\Validation\InvalidStructure
 */
final class DropFunctionsStatement extends BoundStatement
{
    /**
