...
/**
 * Deletes procedure definitions identified by their typed names and argument requests.
 * @visibility public
 * @example Inspecting a deletion request
 *     $statement = (new \SqlSemantics\Binder((new \SqlSemantics\SchemaBuilder(\SqlSemantics\Dialect::PostgreSql))->build()))->bind('DROP PROCEDURE f()');
 *     $statement instanceof \SqlSemantics\Model\Statement\Definition\PostgreSql\DropProceduresStatement // => true
 ...
 *     new \SqlSemantics\Model\Statement\Definition\PostgreSql\DropProceduresStatement($origin, []); // throws \SqlSemantics\Model\Validation\InvalidStructure
 */
final class DropProceduresStatement extends BoundStatement
{
    /**
