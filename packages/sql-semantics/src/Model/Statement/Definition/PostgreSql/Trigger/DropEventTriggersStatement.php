...
/**
 * Requests removal of named event triggers and records dependent-object behavior.
 * @visibility public
 * @example Inspecting all removal targets
 *     $statement = (new \SqlSemantics\Binder((new \SqlSemantics\SchemaBuilder(\SqlSemantics\Dialect::PostgreSql))->build()))->bind('DROP EVENT TRIGGER one, two CASCADE');
 ...
 *     new \SqlSemantics\Model\Statement\Definition\PostgreSql\Trigger\DropEventTriggersStatement($origin, []); // throws \SqlSemantics\Model\Validation\InvalidStructure
 */
final class DropEventTriggersStatement extends BoundStatement
{
    /**
