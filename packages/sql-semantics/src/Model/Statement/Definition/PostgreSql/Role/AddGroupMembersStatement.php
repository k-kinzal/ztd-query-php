...
/**
 * The legacy group form that adds members of a role.
 * @visibility public
 * @example Reading the membership change
 *     $statement = (new \SqlSemantics\Binder((new \SqlSemantics\SchemaBuilder(\SqlSemantics\Dialect::PostgreSql))->build()))->bind('ALTER GROUP staff ADD USER alice, CURRENT_USER');
 ...
 *     new \SqlSemantics\Model\Statement\Definition\PostgreSql\Role\AddGroupMembersStatement($origin, new \SqlSemantics\Model\Configuration\Role\NamedRole('staff'), []); // throws \SqlSemantics\Model\Validation\InvalidStructure
 */
final class AddGroupMembersStatement extends BoundStatement
{
    /**
