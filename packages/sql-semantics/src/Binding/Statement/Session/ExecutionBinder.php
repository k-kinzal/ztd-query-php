...
final class ExecutionBinder
{
    ...
    public static function bind(Origin $origin, Node $statement, QueryContext $context): ?BoundStatement
    {
        ...
        return Statement\Definition\UserMappings::bind($origin, $statement, $context)
            ?? Statement\Definition\WrapperDeclarations::bind($origin, $statement, $context)
            ?? Statement\Definition\ForeignImports::bind($origin, $statement, $context)
