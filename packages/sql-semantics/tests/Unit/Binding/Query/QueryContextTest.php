...
#[CoversClass(\SqlSemantics\Binding\Query\QueryContext::class)]
...
{
    public function testBindKeepsCorrelationInItsOwningScope(): void
    {
        ...
        self::assertSame('r0', $nested->where?->operands[1]->binding?->relationId);
