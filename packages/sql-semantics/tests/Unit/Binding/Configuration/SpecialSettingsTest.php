...
#[\PHPUnit\Framework\Attributes\CoversClass(\SqlSemantics\Binding\Configuration\SpecialSettings::class)]
...
final class SpecialSettingsTest extends TestCase
{
    public function testBindRetainsNamesAndCollation(): void
    {
        ...
        self::assertSame('utf8mb4', $statement->settings[0]->values[0]->symbol);
        self::assertSame('utf8mb4_bin', $statement->settings[1]->values[0]->symbol);
    }
