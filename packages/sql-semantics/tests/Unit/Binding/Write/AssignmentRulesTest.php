...
#[\PHPUnit\Framework\Attributes\CoversClass(\SqlSemantics\Binding\Write\AssignmentRules::class)]
...
{
    public function testCheckRejectsKnownIncompatibleAssignment(): void
    {
        ...
        $binder->bind('UPDATE t SET id=TRUE');
    }
    public function testCheckRejectsNullStorage(): void
    {
        ...
        $binder->bind('INSERT INTO t VALUES(NULL)');
    }
