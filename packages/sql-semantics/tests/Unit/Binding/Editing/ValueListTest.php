...
#[\PHPUnit\Framework\Attributes\CoversClass(\SqlSemantics\Binding\Editing\ValueList::class)]
...
{
    public function testReplacePreservesOtherSettingsAndValueSeparators(): void
    {
        ...
        $tree = \SqlSemantics\Binding\Editing\ValueList::replace($statement, $statement->settings[0], [Expression::literal(3, Dialect::MySql)]);
