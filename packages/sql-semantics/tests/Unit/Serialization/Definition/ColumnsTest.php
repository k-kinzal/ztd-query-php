...
final class ColumnsTest extends TestCase
{
    ...
    #[TestWith([Dialect::MySql, 'd INT NOT NULL AUTO_INCREMENT, KEY (d)', '`d` integer NOT NULL AUTO_INCREMENT', AutoIncrementColumn::class])]
    ...
    {
        $statement = (new Binder((new SchemaBuilder(Dialect::MySql))->build()))->bind('CREATE TABLE t (a INT SERIAL DEFAULT VALUE, b INT UNIQUE, CONSTRAINT named UNIQUE (a))');
        self::assertInstanceOf(CreateTableStatement::class, $statement);
    ...
    {
        $statement = (new Binder((new SchemaBuilder(Dialect::MySql))->build()))->bind('CREATE TABLE t (a INT SERIAL DEFAULT VALUE, b INT UNIQUE, UNIQUE (a))');
        self::assertInstanceOf(CreateTableStatement::class, $statement);
        $table = $statement->definition->table;
