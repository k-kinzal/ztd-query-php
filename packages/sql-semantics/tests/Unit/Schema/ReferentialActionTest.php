...
#[\PHPUnit\Framework\Attributes\CoversClass(\SqlSemantics\Schema\ReferentialAction::class)]
...
{
    public function testRepresentsAllReferentialActions(): void
    {
        self::assertSame(['no-action', 'restrict', 'cascade', 'set-null', 'set-default'], array_column(\SqlSemantics\Schema\ReferentialAction::cases(), 'value'));
    }
