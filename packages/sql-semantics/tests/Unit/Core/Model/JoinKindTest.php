...
#[CoversClass(\SqlSemantics\Core\Model\JoinKind::class)]
...
final class JoinKindTest extends TestCase
{
    ...
    {
        self::assertSame(['cross', 'inner', 'left', 'right', 'full'], array_column(\SqlSemantics\Core\Model\JoinKind::cases(), 'value'));
    }
}
