...
{
    public function testPlatformSuppliesIndependentImplementations(): void
    {
        self::assertInstanceOf(\SqlSemantics\Platform\MySql\Platform::class, Dialect::MySql->platform());
        self::assertInstanceOf(\SqlSemantics\Platform\PostgreSql\Platform::class, Dialect::PostgreSql->platform());
        self::assertInstanceOf(\SqlSemantics\Platform\Sqlite\Platform::class, Dialect::Sqlite->platform());
    }

    public function testNamesTheThreeSupportedLanguages(): void
    {
        self::assertSame(['postgresql', 'mysql', 'sqlite'], array_column(Dialect::cases(), 'value'));
    }
}
