...
final class StatusColumnTest extends TestCase
{
    public function testInputsContainNoFabricatedRuntimeValues(): void
    {
        ...
        self::assertInstanceOf(StatusColumn::class, $column);
    ...
    public function testSpellingIdentifiesTheProducedField(): void
    {
        ...
        $column = $statement->resultColumns()[1]->expression;
        self::assertInstanceOf(StatusColumn::class, $column);
        self::assertSame('Op', $column->spelling());
        self::assertSame('varchar', $column->type->name);
        self::assertSame(\SqlSemantics\Type\Nullability::NotNull, $column->nullability);
    }
    ...
    public function testRejectsMissingProducingStatementIdentity(): void
    {
        ...
        self::assertInstanceOf(StatusColumn::class, $column);
        $this->expectException(\SqlSemantics\Model\Validation\InvalidStructure::class);
        new StatusColumn($column->source, '', $column->field);
    }
}
