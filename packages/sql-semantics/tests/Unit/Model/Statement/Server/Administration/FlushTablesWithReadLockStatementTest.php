...
#[CoversClass(FlushTablesWithReadLockStatement::class)]
#[Medium]
final class FlushTablesWithReadLockStatementTest extends TestCase
{
    ...
    public function testWithTablesReplacesTheTargetsImmutably(): void
    {
        ...
        $statement = $binder->bind('FLUSH TABLES t WITH READ LOCK');
    ...
    public function testRejectsAnotherDialect(): void
    {
        ...
        new FlushTablesWithReadLockStatement(new Origin('s0', $statement->source, Dialect::PostgreSql), $statement->tables);
    }
}
