...
#[CoversClass(\SqlSemantics\Model\Statement\Definition\PostgreSql\DropFunctionsStatement::class)]
#[Medium]
final class DropFunctionsStatementTest extends TestCase
{
    public function testWithTargetsReplacesTheRequestWithoutMutatingItsSource(): void
    {
        $statement = (new Binder((new SchemaBuilder(Dialect::PostgreSql))->build()))->bind('DROP FUNCTION f()');
        self::assertInstanceOf(\SqlSemantics\Model\Statement\Definition\PostgreSql\DropFunctionsStatement::class, $statement);
        ...
        self::assertSame('DROP FUNCTION "app"."g"', $changed->toString());
