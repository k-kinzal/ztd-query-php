...
#[CoversClass(DropForeignServersStatement::class)]
#[Medium]
final class DropForeignServersStatementTest extends TestCase
{
    public function testWithOriginRetainsTheConcreteOperation(): void
    {
        $statement = (new Binder((new SchemaBuilder(Dialect::PostgreSql))->build()))->bind('DROP SERVER one, two');
