...
final class AddGroupMembersStatementTest extends TestCase
{
    ...
    {
        $statement = (new Binder((new SchemaBuilder(Dialect::PostgreSql))->build()))->bind('ALTER GROUP staff ADD USER alice, CURRENT_USER');
        self::assertSame('ALTER GROUP "staff" ADD USER "alice", CURRENT_USER', (new \SqlSemantics\SimpleSerializer())->serialize($statement));
    }
    ...
    public function testWithGroupReplacesTheGroupWithoutMutatingTheOriginal(): void
    {
        ...
        self::assertSame('ALTER GROUP SESSION_USER ADD USER "alice", CURRENT_USER', (new \SqlSemantics\SimpleSerializer())->serialize($changed));
    }
    ...
    public function testWithMembersReplacesAndQuotesTheCompleteSelection(): void
    {
        ...
        self::assertSame('ALTER GROUP "staff" ADD USER "x""y", CURRENT_ROLE', (new \SqlSemantics\SimpleSerializer())->serialize($changed));
    }
