...
final class CreateForeignTableStatementTest extends TestCase
{
    public function testBindsTheOperandsAndWritesThemBack(): void
    {
        ...
        self::assertSame('CREATE FOREIGN TABLE IF NOT EXISTS "app"."ft"("a" integer NOT NULL, CHECK (("a" > 0))) INHERITS("p") SERVER "remote" OPTIONS("schema_name" \'x\')', $statement->toString());
    ...
    public function testWithOptionsReplacesTheOperand(): void
    {
        ...
        self::assertStringContainsString('SERVER "remote"', $changed->toString());
    }
    ...
    public function testWithInheritsReplacesTheOperand(): void
    {
        ...
        self::assertStringContainsString('INHERITS("q")', $changed->toString());
    }
    ...
    public function testWithIfNotExistsReplacesTheOperand(): void
    {
        ...
        self::assertStringContainsString('CREATE FOREIGN TABLE "app"', $changed->toString());
    }
