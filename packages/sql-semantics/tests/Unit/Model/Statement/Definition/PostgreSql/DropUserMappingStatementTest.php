...
#[CoversClass(DropUserMappingStatement::class)]
#[Medium]
final class DropUserMappingStatementTest extends TestCase
{
    public function testWithTargetReplacesTheUserAndServerTogether(): void
    {
        $statement = (new Binder((new SchemaBuilder(Dialect::PostgreSql))->build()))->bind('DROP USER MAPPING FOR USER SERVER remote');
