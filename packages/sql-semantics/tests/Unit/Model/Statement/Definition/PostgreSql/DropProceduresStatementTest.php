...
#[CoversClass(\SqlSemantics\Model\Statement\Definition\PostgreSql\DropProceduresStatement::class)]
#[Medium]
final class DropProceduresStatementTest extends TestCase
{
    public function testWithTargetsReplacesTheRequestWithoutMutatingItsSource(): void
    {
        $statement = (new Binder((new SchemaBuilder(Dialect::PostgreSql))->build()))->bind('DROP PROCEDURE f()');
        self::assertInstanceOf(\SqlSemantics\Model\Statement\Definition\PostgreSql\DropProceduresStatement::class, $statement);
        ...
        self::assertSame('DROP PROCEDURE "app"."g"', $changed->toString());
