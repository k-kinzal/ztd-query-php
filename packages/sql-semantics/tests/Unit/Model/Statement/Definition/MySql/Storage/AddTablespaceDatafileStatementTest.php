...
use SqlSemantics\Model\Statement\Definition\MySql\Storage\AddTablespaceDatafileStatement;
use SqlSemantics\Model\Validation\InvalidStructure;
use SqlSemantics\SchemaBuilder;

#[CoversClass(AddTablespaceDatafileStatement::class)]
#[Medium]
final class AddTablespaceDatafileStatementTest extends TestCase
{
    ...
    {
        $statement = (new Binder((new SchemaBuilder(Dialect::MySql, grammarVersion: $version))->build()))->bind("ALTER TABLESPACE ts ADD DATAFILE 'f.ibd' INITIAL_SIZE 2K");
    ...
    {
        $statement = (new Binder((new SchemaBuilder(Dialect::MySql))->build()))->bind("ALTER TABLESPACE ts ADD DATAFILE 'f.ibd'");
        self::assertInstanceOf(AddTablespaceDatafileStatement::class, $statement);
    ...
    {
        $statement = (new Binder((new SchemaBuilder(Dialect::MySql, grammarVersion: 'mysql-5.7.44'))->build()))->bind("ALTER TABLESPACE ts ADD DATAFILE 'f.ibd'");
        self::assertInstanceOf(AddTablespaceDatafileStatement::class, $statement);
