...
final class CreateExtensionStatementTest extends TestCase
{
    public function testBindsTheOptionsAndWritesThemBack(): void
    {
        ...
        self::assertSame('CREATE EXTENSION IF NOT EXISTS "hstore" SCHEMA "app" VERSION \'1.8\' CASCADE', (new \SqlSemantics\SimpleSerializer())->serialize($statement));
    ...
    public function testWithNameReplacesTheExtension(): void
    {
        ...
        self::assertSame('CREATE EXTENSION "citext"', (new \SqlSemantics\SimpleSerializer())->serialize($changed));
    }
    ...
    public function testWithIfNotExistsReplacesTheExistencePolicy(): void
    {
        ...
        self::assertSame('CREATE EXTENSION IF NOT EXISTS "hstore"', (new \SqlSemantics\SimpleSerializer())->serialize($changed));
    }
    ...
    public function testWithSchemaReplacesTheSchema(): void
    {
        ...
        self::assertSame('CREATE EXTENSION "hstore"', (new \SqlSemantics\SimpleSerializer())->serialize($changed));
    }
    ...
    public function testWithVersionReplacesTheVersion(): void
    {
        ...
        self::assertSame('CREATE EXTENSION "hstore" VERSION \'1\'\'0\'', (new \SqlSemantics\SimpleSerializer())->serialize($changed));
    }
