...
#[CoversClass(RepairTablesStatement::class)]
#[Medium]
final class RepairTablesStatementTest extends TestCase
{
    public function testResultColumnsExposeTypedServerOutputs(): void
    {
        ...
        $statement = $binder->bind('REPAIR LOCAL TABLE t QUICK');
    ...
    public function testWithTablesResolvesNewTargetsAndRetainsTheOriginal(): void
    {
        ...
        self::assertSame('REPAIR NO_WRITE_TO_BINLOG TABLE `u` QUICK', $changed->toString());
    ...
    public function testWithOptionsChangesOnlyTheSelectedRequest(): void
    {
        ...
        $changed = $statement->withOptions([RepairOption::Extended, RepairOption::UseDefinitionFile]);
        self::assertSame('REPAIR NO_WRITE_TO_BINLOG TABLE `t` EXTENDED USE_FRM', $changed->toString());
        self::assertSame([RepairOption::Extended, RepairOption::UseDefinitionFile], $changed->options);
    ...
    public function testWithBinlogChangesOnlyTheSelectedRequest(): void
    {
        ...
        $changed = $statement->withBinlog(BinlogPolicy::Write);
        self::assertSame('REPAIR TABLE `t` QUICK', $changed->toString());
        self::assertSame(BinlogPolicy::Write, $changed->binlog);
