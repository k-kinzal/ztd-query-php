...
use SqlSemantics\Model\Statement\Maintenance\MySql\OptimizeTablesStatement;
use SqlSemantics\SchemaBuilder;

#[CoversClass(OptimizeTablesStatement::class)]
#[Medium]
final class OptimizeTablesStatementTest extends TestCase
{
    public function testResultColumnsExposeTypedServerOutputs(): void
    {
        ...
        $statement = $binder->bind('OPTIMIZE TABLE t');
        self::assertInstanceOf(OptimizeTablesStatement::class, $statement);
    ...
    public function testWithTablesResolvesNewTargetsAndRetainsTheOriginal(): void
    {
        ...
        self::assertSame('OPTIMIZE TABLE `u`', $changed->toString());
    ...
    public function testWithBinlogChangesOnlyTheSelectedRequest(): void
    {
        ...
        self::assertSame('OPTIMIZE NO_WRITE_TO_BINLOG TABLE `t`', $changed->toString());
