...
final class MergeStatementTest extends TestCase
{
    public function testWithConditionRefreshesDependentFacts(): void
    {
        ...
        self::assertSame('FALSE', $changed->merge?->condition->symbol);
        self::assertSame('delete', $changed->merge->actions[0]->action);
        self::assertSame('=', $statement->merge?->condition->symbol);
    }
}
