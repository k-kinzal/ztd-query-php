...
final class UpdateTableStatementTest extends TestCase
{
    public function testReturningDoesNotCreateAWherePredicate(): void
    {
        ...
        self::assertSame('UPDATE OR IGNORE "main"."t" SET "id" = 1 RETURNING "id" AS "id"', (new \SqlSemantics\SimpleSerializer())->serialize($statement));
    }
    ...
    public function testWithOriginKeepsTheTargetAndWrites(): void
    {
        ...
        self::assertSame('UPDATE "public"."t" SET "n" = 1 RETURNING "id" AS "id"', (new \SqlSemantics\SimpleSerializer())->serialize($changed));
    }
    ...
    public function testWithWhereAddsAndRemovesThePredicate(): void
    {
        ...
        self::assertSame('UPDATE "public"."t" SET "n" = 1 WHERE ("id" > 1) RETURNING "id" AS "id"', (new \SqlSemantics\SimpleSerializer())->serialize($changed));
    ...
    public function testWithAssignmentsReplacesTheWrites(): void
    {
        ...
        self::assertSame('UPDATE "public"."t" SET "id" = 5, "n" = 6 RETURNING "id" AS "id"', (new \SqlSemantics\SimpleSerializer())->serialize($changed));
        self::assertCount(2, $changed->writes);
        self::assertCount(1, $statement->writes);
        self::assertSame('UPDATE "public"."t" SET "n" = 1 RETURNING "id" AS "id"', (new \SqlSemantics\SimpleSerializer())->serialize($statement));
    }
}
