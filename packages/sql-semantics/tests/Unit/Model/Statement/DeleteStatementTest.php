...
#[\PHPUnit\Framework\Attributes\CoversClass(\SqlSemantics\Model\Statement\DeleteStatement::class)]
...
final class DeleteStatementTest extends TestCase
{
    ...
    {
        $statement = (new Binder((new SchemaBuilder($dialect))->build('CREATE TABLE t(id INTEGER,n INTEGER)')))->bind('DELETE FROM t');
