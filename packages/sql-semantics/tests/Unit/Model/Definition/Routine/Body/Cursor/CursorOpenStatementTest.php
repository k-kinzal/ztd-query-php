...
#[CoversClass(CursorOpenStatement::class)]
#[Medium]
final class CursorOpenStatementTest extends TestCase
{
    public function testNamesADeclaredCursor(): void
    {
        $binder = new Binder((new SchemaBuilder(Dialect::MySql))->build());
        $statement = $binder->bind('CREATE PROCEDURE p() BEGIN DECLARE rows_c CURSOR FOR SELECT 1; OPEN Rows_C; END');
    ...
    public function testDiagnosesAnUndeclaredCursor(): void
    {
        ...
        (new Binder((new SchemaBuilder(Dialect::MySql))->build()))->bind('CREATE PROCEDURE p() OPEN c', strict: false);
    }
}
