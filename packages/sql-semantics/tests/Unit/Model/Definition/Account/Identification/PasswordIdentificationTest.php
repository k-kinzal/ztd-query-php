...
#[CoversClass(PasswordIdentification::class)]
#[Medium]
final class PasswordIdentificationTest extends TestCase
{
    public function testKeepsTheSuppliedOperands(): void
    {
        ...
        $identification = new PasswordIdentification($literal);
        self::assertSame("'x'", $identification->password->text);
    }
    ...
    public function testRejectsAnInvalidOperand(): void
    {
        ...
        new PasswordIdentification($number);
    }
}
