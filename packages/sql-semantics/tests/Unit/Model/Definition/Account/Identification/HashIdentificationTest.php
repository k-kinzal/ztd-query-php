...
#[CoversClass(HashIdentification::class)]
#[Medium]
final class HashIdentificationTest extends TestCase
{
    public function testKeepsTheSuppliedOperands(): void
    {
        ...
        $identification = new HashIdentification($literal);
        self::assertSame("'x'", $identification->hash->text);
    }
