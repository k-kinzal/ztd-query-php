...
#[CoversClass(Relation\Column\SetColumnNullability::class)]
#[Medium]
final class SetColumnNullabilityTest extends TestCase
{
    ...
    public function testRejectsAnUnknownNullability(): void
    {
        ...
        new Relation\Column\SetColumnNullability('id', \SqlSemantics\Type\Nullability::Unknown);
    }
}
