...
#[CoversClass(SetForeignOption::class)]
#[Medium]
final class SetForeignOptionTest extends TestCase
{
    public function testRequiredOptionRetainsBothItsNameAndText(): void
    {
        $statement = (new Binder((new SchemaBuilder(Dialect::PostgreSql))->build()))->bind("ALTER FOREIGN DATA WRAPPER fdw OPTIONS (SET format 'csv')");
        self::assertInstanceOf(AlterForeignDataWrapperStatement::class, $statement);
        self::assertInstanceOf(SetForeignOption::class, $statement->options[0]);
