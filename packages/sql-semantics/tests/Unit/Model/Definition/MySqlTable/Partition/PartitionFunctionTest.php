...
use SqlSemantics\Model\Definition\MySqlTable\Partition\PartitionFunction;
use SqlSemantics\Model\Definition\MySqlTable\Table\RepartitionTable;
use SqlSemantics\Model\Statement\Definition\MySql\Table\AlterTableStatement;
use SqlSemantics\SchemaBuilder;

#[CoversClass(PartitionFunction::class)]
#[Medium]
final class PartitionFunctionTest extends TestCase
{
    public function testClassifiesEveryFunction(): void
    {
        ...
        self::assertContains(PartitionFunction::class, class_implements($partitioning->function));
    }
}
