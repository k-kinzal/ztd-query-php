...
{
    public function testReadsTheColumnAndBehavior(): void
    {
        $statement = (new Binder((new SchemaBuilder(Dialect::MySql))->build('CREATE TABLE t(id INT, n INT)')))->bind('ALTER TABLE t DROP n RESTRICT');
        self::assertInstanceOf(AlterTableStatement::class, $statement);
        $alteration = $statement->alterations[0];
        self::assertInstanceOf(DropColumn::class, $alteration);
        self::assertSame('n', $alteration->column);
        self::assertSame(DropBehavior::Restrict, $alteration->behavior);
    }
