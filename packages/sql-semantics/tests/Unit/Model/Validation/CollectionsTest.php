...
{
    public function testObjectsRejectsIncorrectElementType(): void
    {
        $this->expectException(InvalidStructure::class);
        \SqlSemantics\Model\Validation\Collections::objects([new stdClass()], \SqlSemantics\Model\Expression::class);
    }
    public function testStringsRejectsIncorrectElementType(): void
    {
        $this->expectException(InvalidStructure::class);
        \SqlSemantics\Model\Validation\Collections::strings(['valid', 1]);
    }
    ...
    public function testComponentsRejectsNonStructuralValues(): void
    {
        $this->expectException(InvalidStructure::class);
