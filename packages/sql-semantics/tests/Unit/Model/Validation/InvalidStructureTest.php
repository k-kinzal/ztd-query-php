...
#[\PHPUnit\Framework\Attributes\CoversClass(InvalidStructure::class)]
...
final class InvalidStructureTest extends TestCase
{
    public function testPreservesTheConstructionFailure(): void
    {
        $failure = new InvalidStructure('Invalid output order');
        self::assertSame('Invalid output order', $failure->getMessage());
    }
}
