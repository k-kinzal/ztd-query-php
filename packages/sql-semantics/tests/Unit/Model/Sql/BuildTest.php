...
#[\PHPUnit\Framework\Attributes\CoversClass(Sql\Build::class)]
...
{
    public function testSeparatedPreservesOrderAndEmptyLists(): void
    {
        self::assertSame('a, b', Sql\Build::separated([Sql\Build::keyword('a'), Sql\Build::keyword('b')])->toString());
        self::assertSame('', Sql\Build::separated([])->toString());
    }
    public function testParenthesesProtectsExpressionPrecedence(): void
    {
        self::assertSame('(1 + 2)', Sql\Build::parentheses(new Sql\Tree('sum', [Sql\Build::keyword('1'), Sql\Build::keyword('+'), Sql\Build::keyword('2')]))->toString());
    }
    public function testIdentifierQuotesNamesAndEscapesEmbeddedQuotes(): void
    {
        self::assertSame('"my""schema"."column"', Sql\Build::identifier(['my"schema','column'], Dialect::PostgreSql)->toString());
        self::assertSame('`my``table`', Sql\Build::identifier(['my`table'], Dialect::MySql)->toString());
    }
    public function testKeywordStoresTrustedGrammarText(): void
    {
        self::assertSame('ORDER BY', Sql\Build::keyword('ORDER BY')->toString());
    }
}
