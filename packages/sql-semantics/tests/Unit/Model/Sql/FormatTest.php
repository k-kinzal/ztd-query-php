...
#[\PHPUnit\Framework\Attributes\CoversClass(Sql\Format::class)]
...
final class FormatTest extends TestCase
{
    ...
    #[\PHPUnit\Framework\Attributes\TestWith(['COUNT','(',true])]
    #[\PHPUnit\Framework\Attributes\TestWith(['(',')',true])]
    #[\PHPUnit\Framework\Attributes\TestWith(['a',',',true])]
    #[\PHPUnit\Framework\Attributes\TestWith(['a','.',true])]
    #[\PHPUnit\Framework\Attributes\TestWith(['.','1',false])]
    #[\PHPUnit\Framework\Attributes\TestWith(['1','.',false])]
    #[\PHPUnit\Framework\Attributes\TestWith(['@','value',true])]
    #[\PHPUnit\Framework\Attributes\TestWith(['-','-',false])]
    #[\PHPUnit\Framework\Attributes\TestWith(['/','*',false])]
    public function testAdjacentPreservesLexicalBoundaries(string $left, string $right, bool $expected): void
    {
        self::assertSame($expected, Sql\Format::adjacent(new Sql\Atom('terminal', $left), new Sql\Atom('terminal', $right)));
    }
    public function testWriteSkipsEmptyEndMarkersAndSeparatesAnnotations(): void
    {
