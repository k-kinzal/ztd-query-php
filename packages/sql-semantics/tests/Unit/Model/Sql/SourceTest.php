...
#[\PHPUnit\Framework\Attributes\CoversClass(Sql\Source::class)]
...
{
    public function testReadOwnsSyntaxWithoutSourceFormatting(): void
    {
        $source = new \SqlParser\Parser\Node('query', 0, [new \SqlParser\Lexer\Token(1, 'SELECT', 'SELECT', 12, "\n/* ordinary */ "), new \SqlParser\Lexer\Token(2, 'integer', '1', 40, '  ')], ' -- end');
        $tree = Sql\Source::read($source);
        self::assertSame('SELECT 1', $tree->toString());
        self::assertSame('query', $tree->role);
    }
    public function testAnnotationsIgnoresHintsInsideOtherComments(): void
    {
        self::assertSame([], Sql\Source::annotations("/* ordinary /*+ not a hint */ */ -- /*+ fake */\n # /*+ fake */\n"));
        self::assertSame(['/*+ genuine */','/*!99999 SELECT 1 */'], array_column(Sql\Source::annotations(' /*+ genuine */ /*!99999 SELECT 1 */'), 'text'));
    }
    public function testCommentEndUnderstandsNestedAndIncompleteComments(): void
    {
        self::assertSame(11, Sql\Source::commentEnd('/*a/*b*/c*/ x', 0));
