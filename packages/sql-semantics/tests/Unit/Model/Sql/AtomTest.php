...
#[\PHPUnit\Framework\Attributes\CoversClass(Sql\Atom::class)]
...
{
    public function testStoresTerminalIdentityAndExactLiteralContent(): void
    {
        $atom = new Sql\Atom('literal', "'a  b'");
        self::assertSame('literal', $atom->kind);
        self::assertSame("'a  b'", $atom->text);
    }
}
