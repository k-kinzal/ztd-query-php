...
#[\PHPUnit\Framework\Attributes\CoversClass(\SqlSemantics\Model\Transformation\Context::class)]
...
{
    public function testSchemaRetainsTheImmutableInterpretationSnapshot(): void
    {
    ...
    public function testRebindReturnsAnIndependentValidatedSnapshot(): void
    {
        $schema = (new SchemaBuilder(Dialect::Sqlite))->build();
        $context = new \SqlSemantics\Binding\Editing\StatementContext($schema);
