...
```php
$builder = new \SqlSemantics\Core\SchemaBuilder(\SqlSemantics\Facade\Dialect::PostgreSql);
...
```php
$schema = (new \SqlSemantics\Core\SchemaBuilder(\SqlSemantics\Facade\Dialect::PostgreSql))->build('CREATE TABLE users (id INTEGER PRIMARY KEY, score INTEGER NOT NULL)');
$schema->dialect->value // => 'postgresql'
```

```php
$schema = (new \SqlSemantics\Core\SchemaBuilder(\SqlSemantics\Facade\Dialect::PostgreSql))->build('CREATE TABLE users (id INTEGER PRIMARY KEY)');
...
```php
$type = new \SqlSemantics\Core\Type\TypeDescriptor(\SqlSemantics\Facade\Dialect::PostgreSql, 'numeric', ['10', '2']);
$type->modifiers // => ['10', '2']
```
