...
#[CoversClass(\ZtdQuery\Platform\Postgres\Parsing\Relation\FromClause::class)]
...
final class FromClauseTest extends TestCase
{
    ...
    {
        self::assertSame([['name' => 'users', 'start' => 0, 'unqualifiedStart' => 0, 'end' => 5], ['name' => 'orders', 'start' => 13, 'unqualifiedStart' => 13, 'end' => 19]], (new \ZtdQuery\Platform\Postgres\Parsing\Relation\FromClause())->referencesFromClause('users u JOIN orders o ON u.id = o.user_id'));
    }
    ...
    public function testFindFromEnd(): void
    {
        ...
        self::assertSame(56, (new \ZtdQuery\Platform\Postgres\Parsing\Relation\FromClause())->findFromEnd($sql, $tokens, $tokens[2]));
    }
    ...
    public function testMatchesKeywordSequence(): void
    {
        ...
        self::assertSame(true, (new \ZtdQuery\Platform\Postgres\Parsing\Relation\FromClause())->matchesKeywordSequence($tokens, 0, ['LEFT', 'JOIN']));
    }
    public function testParenthesizedReferencesRebasesJoinedRelationOffsets(): void
    {
        ...
        $references = (new \ZtdQuery\Platform\Postgres\Parsing\Relation\FromClause())->parenthesizedReferences($sql, $tokens, 0, $tokens[0]);
