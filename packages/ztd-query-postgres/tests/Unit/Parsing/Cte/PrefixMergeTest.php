...
#[CoversClass(\ZtdQuery\Platform\Postgres\Parsing\Cte\PrefixMerge::class)]
...
final class PrefixMergeTest extends TestCase
{
    public function testPrependRewrittenRetainsRecursiveAndLeadingCommentSyntax(): void
    {
        ...
        $merged = (new \ZtdQuery\Platform\Postgres\Parsing\Cte\PrefixMerge())->prependRewritten($original, $offset, 'shadow AS (SELECT 2)', 'SELECT * FROM shadow');
