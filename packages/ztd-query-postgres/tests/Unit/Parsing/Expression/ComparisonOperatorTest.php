...
#[CoversClass(\ZtdQuery\Platform\Postgres\Parsing\Expression\ComparisonOperator::class)]
...
final class ComparisonOperatorTest extends TestCase
{
    public function testComparisonOperatorConsumesBothCharacters(): void
    {
        ...
        self::assertSame(\ZtdQuery\Shadow\Mutation\UpsertExpressionKind::GreaterOrEqual, (new \ZtdQuery\Platform\Postgres\Parsing\Expression\ComparisonOperator($cursor))->comparisonOperator());
    ...
    public function testComparisonOperatorLeavesOtherTokensUntouched(): void
    {
        ...
        $tokens = \ZtdQuery\Sql\SqlTokenStream::tokenize($sql, \ZtdQuery\Platform\Postgres\PgSqlLexerProfile::create())->significantTokens();
        $cursor = new \ZtdQuery\Platform\Postgres\Parsing\Expression\ExpressionCursor($sql, 'users', $tokens);
        self::assertNull((new \ZtdQuery\Platform\Postgres\Parsing\Expression\ComparisonOperator($cursor))->comparisonOperator());
