...
{
    public function testParseKeyParsesRangePartitionKeyAndBounds(): void
    {
    ...
    public function testParseRelationParsesListPartitionIncludingNull(): void
    {
        $parser = new PgSqlPartitionParser();
    ...
    public function testParentTableRejectsMalformedPartitionClauses(): void
    {
        $parser = new PgSqlPartitionParser();
