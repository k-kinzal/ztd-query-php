...
final class PgSqlPartitionReflectorTest extends TestCase
{
    ...
    {
        $keyStatement = self::createStub(\ZtdQuery\Connection\StatementInterface::class);
        $keyStatement->method('fetchAll')->willReturn([['table_name' => null, 'partition_key' => 'RANGE (id)'], ['table_name' => '', 'partition_key' => 'RANGE (id)'], ['table_name' => 'broken', 'partition_key' => null], ['table_name' => 'invalid', 'partition_key' => 'invalid'], ['table_name' => 'logs', 'partition_key' => 'RANGE (log_date)']]);
        $relationStatement = self::createStub(\ZtdQuery\Connection\StatementInterface::class);
        $relationStatement->method('fetchAll')->willReturn([['child_table' => null, 'parent_table' => 'logs', 'predicate' => 'TRUE'], ['child_table' => '', 'parent_table' => 'logs', 'predicate' => 'TRUE'], ['child_table' => 'missing_parent', 'parent_table' => null, 'predicate' => 'TRUE'], ['child_table' => 'empty_parent', 'parent_table' => '', 'predicate' => 'TRUE'], ['child_table' => 'missing_predicate', 'parent_table' => 'logs', 'predicate' => null], ['child_table' => 'blank_predicate', 'parent_table' => 'logs', 'predicate' => ' '], ['child_table' => 'logs_2024', 'parent_table' => 'logs', 'predicate' => "((log_date >= '2024-01-01'::date) AND (log_date < '2025-01-01'::date))"]]);
        $queries = [];
        $connection = self::createStub(ConnectionInterface::class);
        $connection->method('query')->willReturnCallback(static function (string $sql) use (&$queries, $keyStatement, $relationStatement) {
            $queries[] = $sql;
