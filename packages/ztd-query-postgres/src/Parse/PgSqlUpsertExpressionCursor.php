 ...
 */
final class PgSqlUpsertExpressionCursor
{
     ...
     * @param PgSqlUpsertLiteral $literals Reads a literal or a name back out of how it was written
     */
    public function __construct(
        ...
        private readonly PgSqlUpsertLiteral $literals = new PgSqlUpsertLiteral(),
    ) {
    }
