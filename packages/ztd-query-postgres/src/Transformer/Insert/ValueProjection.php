...
final class ValueProjection
{
     ...
     * @param array{rows?: array<int, array<string, T>>, columnTypes?: array<string, ColumnType>, columnDefaults?: array<string, string>, identityStrategies?: array<string, \ZtdQuery\Schema\IdentityGenerationStrategy>, storageTable?: string} $table
