...
final class DdlResolver
{
    ...
    /**
     * Supplies the dependencies used by this DdlResolver.
     */
    ...
    public function resolveCreateTable(string $sql): ShadowMutation
    {
        ...
        if ($this->parser->hasCreateTableAsSelect($sql)) {
            ...
            $columnNames = $selectSql !== null ? (new \ZtdQuery\Platform\Postgres\Parsing\Statement\SelectColumns())->extractSelectColumnNames($selectSql) : [];
