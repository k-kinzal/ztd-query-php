...
final class SchemaContext
{
    ...
    /**
     * Supplies the dependencies used by this SchemaContext.
     */
     ...
     * @template T
     * @param array<string, array{rows: array<int, array<string, T>>, columns: array<int, string>, columnTypes: array<string, \ZtdQuery\Schema\ColumnType>, columnDefaults: array<string, string>, identityStrategies: array<string, \ZtdQuery\Schema\IdentityGenerationStrategy>, generatedExpressions: array<string, string>, primaryKeys: array<int, string>, candidateKeys: array<string, array<int, string>>, partialUniqueIndexes: array<string, \ZtdQuery\Schema\PartialUniqueIndex>, sourceSql?: string, storageTable?: string}> $context
     * @return array<string, array{rows: array<int, array<string, T>>, columns: array<int, string>, columnTypes: array<string, \ZtdQuery\Schema\ColumnType>, columnDefaults: array<string, string>, identityStrategies: array<string, \ZtdQuery\Schema\IdentityGenerationStrategy>, generatedExpressions: array<string, string>, primaryKeys: array<int, string>, candidateKeys: array<string, array<int, string>>, partialUniqueIndexes: array<string, \ZtdQuery\Schema\PartialUniqueIndex>, sourceSql?: string, storageTable?: string}>
     */
