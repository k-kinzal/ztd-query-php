...
final class DeclarationParser
{
    ...
    public function directive(Token $token, TokenStream $tokens): Declaration
    {
        ...
        return match ($name) {
            ...
            'token' => new SymbolDeclaration(SymbolClass::Token, $this->symbols->tokenDeclarations($tokens), $at),
            'nterm' => new SymbolDeclaration(SymbolClass::Nonterminal, $this->symbols->ntermDeclarations($tokens), $at),
