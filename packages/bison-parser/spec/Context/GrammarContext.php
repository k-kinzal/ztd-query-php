...
/**
 * Steps of the specification: give a grammar file, parse it with the public
 * parser, and state either the whole resulting tree or the position at which
 * parsing fails.
 */
final class GrammarContext implements Context
{
    ...
    /**
     * States that the parse produced the same tree as another grammar file does.
     *
