...
final class SchemaParserFuzzTest extends TestCase
{
    ...
    /**
     * Checks parse does not crash on random create table.
     */
    ...
    /**
     * Checks parse structural invariants on random create table.
     */
    ...
    /**
     * Checks parse returns null on non create table sql.
     */
