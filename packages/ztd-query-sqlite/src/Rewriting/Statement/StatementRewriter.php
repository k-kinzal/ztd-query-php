...
namespace ZtdQuery\Platform\Sqlite\Rewriting\Statement;

use ZtdQuery\Exception\UnknownSchemaException;
use ZtdQuery\Exception\UnsupportedSqlException;
use ZtdQuery\Platform\Sqlite\Mutation\AlterTableMutation;
use ZtdQuery\Platform\Sqlite\Rewriting\Context\ReferencedTableLookup;
...
final class StatementRewriter
{
    ...
    public function rewriteStatement(string $stmtSql, string $originalSql): RewritePlan
    {
        ...
        $tableContext = (new \ZtdQuery\Platform\Sqlite\Rewriting\Context\TableContextBuilder($this->registry, $this->shadowStore->getAll(), $this->views))->buildTableContext();
