...
final class SqliteNativeUpsertProjector
{
    ...
    public function project(
        ...
        $binder = new Rewriting\Upsert\UpsertExpressionBinder($this->incomingNamespaces, $this->quoter);
        ...
        $conflict = (new Rewriting\Upsert\UpsertConflictPredicate($this->quoter))->conflictPredicate($candidateKeys, $existingAlias, $incomingAlias);
