...
final class RenameResolver
{
    ...
    {
        $newName = (new \ZtdQuery\Platform\Sqlite\Parsing\Alter\AlterOperationParser())->singleIdentifier($tableClause);
        if ($newName === null) {
    ...
    {
        $renamed = (new \ZtdQuery\Platform\Sqlite\Parsing\Alter\AlterOperationParser())->renamedIdentifiers($columnClause);
        if ($renamed === null) {
