...
final class SqliteMutationResolverTest extends TestCase
{
    ...
    public function testResolveAlterTableRenameColumnTypedColumnsUpdated(): void
    {
        ...
        $registry->register('t', new TableDefinition(
            ...
            [],
            [],
            ['id' => new \ZtdQuery\Schema\ColumnDeclaration(\ZtdQuery\Schema\ColumnTypeFamily::INTEGER, 'INTEGER'), 'val' => new \ZtdQuery\Schema\ColumnDeclaration(\ZtdQuery\Schema\ColumnTypeFamily::FLOAT, 'REAL')],
        ));
        $store = new ShadowStore();
        $resolver = new SqliteMutationResolver($store, $registry, new SqliteSchemaParser(), new SqliteParser());
    ...
    public function testResolveAlterTableDropColumnTypedColumnsUpdated(): void
    {
        ...
        $registry->register('t', new TableDefinition(
            ...
            [],
            [],
            ['id' => new \ZtdQuery\Schema\ColumnDeclaration(\ZtdQuery\Schema\ColumnTypeFamily::INTEGER, 'INTEGER'), 'val' => new \ZtdQuery\Schema\ColumnDeclaration(\ZtdQuery\Schema\ColumnTypeFamily::TEXT, 'TEXT')],
        ));
        $store = new ShadowStore();
        $resolver = new SqliteMutationResolver($store, $registry, new SqliteSchemaParser(), new SqliteParser());
    ...
    public function testResolveAlterTableAddColumnWithTypedColumns(): void
    {
        ...
        $registry->register('t', new TableDefinition(
            ...
            [],
            [],
            ['id' => new \ZtdQuery\Schema\ColumnDeclaration(\ZtdQuery\Schema\ColumnTypeFamily::INTEGER, 'INTEGER')],
        ));
        $store = new ShadowStore();
        $resolver = new SqliteMutationResolver($store, $registry, new SqliteSchemaParser(), new SqliteParser());
