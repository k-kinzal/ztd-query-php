...
use ZtdQuery\Platform\Sqlite\Rewriting\Upsert\UpsertExpressionBinder;
...
final class UpsertExpressionBinderTest extends TestCase
{
    ...
    {
        $binder = new UpsertExpressionBinder(['EXCLUDED'], new \ZtdQuery\Platform\Sqlite\SqliteIdentifierQuoter());
