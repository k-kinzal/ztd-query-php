...
namespace Tests\Unit\Rewriting\FullText;

use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\UsesClass;
use PHPUnit\Framework\TestCase;
use ZtdQuery\Platform\Sqlite\Rewriting\FullText\MatchExpressionRewriter;
...
final class MatchExpressionRewriterTest extends TestCase
{
    public function testExpressionEditProjectsAllDocumentColumns(): void
    {
        ...
        $rewriter = new MatchExpressionRewriter(new \ZtdQuery\Platform\Sqlite\SqliteParser(), new \ZtdQuery\Platform\Sqlite\SqliteIdentifierQuoter());
