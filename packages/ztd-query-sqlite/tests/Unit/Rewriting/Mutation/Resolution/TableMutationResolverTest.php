...
namespace Tests\Unit\Rewriting\Mutation\Resolution;
...
use ZtdQuery\Platform\Sqlite\Rewriting\Mutation\Resolution\TableMutationResolver;
...
final class TableMutationResolverTest extends TestCase
{
    ...
    {
        $registry = new TableDefinitionRegistry();
        $registry->register('t', new TableDefinition(['id', 'val'], ['id' => 'INTEGER', 'val' => 'REAL'], ['id'], [], [], ['id' => new ColumnType(ColumnTypeFamily::INTEGER, 'INTEGER'), 'val' => new ColumnType(ColumnTypeFamily::FLOAT, 'REAL')]));
        $store = new ShadowStore();
        $resolver = new TableMutationResolver(new SqliteParser(), $registry, new SqliteSchemaParser());
    ...
    {
        $registry = new TableDefinitionRegistry();
        $registry->register('t', new TableDefinition(['id', 'val'], ['id' => 'INTEGER', 'val' => 'TEXT'], ['id'], [], [], ['id' => new ColumnType(ColumnTypeFamily::INTEGER, 'INTEGER'), 'val' => new ColumnType(ColumnTypeFamily::TEXT, 'TEXT')]));
        $store = new ShadowStore();
        $resolver = new TableMutationResolver(new SqliteParser(), $registry, new SqliteSchemaParser());
    ...
    {
        $registry = new TableDefinitionRegistry();
        $registry->register('t', new TableDefinition(['id'], ['id' => 'INTEGER'], ['id'], [], [], ['id' => new ColumnType(ColumnTypeFamily::INTEGER, 'INTEGER')]));
        $store = new ShadowStore();
        $resolver = new TableMutationResolver(new SqliteParser(), $registry, new SqliteSchemaParser());
