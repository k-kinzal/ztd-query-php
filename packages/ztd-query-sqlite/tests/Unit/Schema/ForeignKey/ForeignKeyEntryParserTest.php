...
use ZtdQuery\Platform\Sqlite\Schema\ForeignKey\ForeignKeyEntryParser;
...
final class ForeignKeyEntryParserTest extends TestCase
{
    ...
    {
        $parser = new ForeignKeyEntryParser();
        self::assertSame(\ZtdQuery\Schema\ReferentialAction::Restrict, $parser->action(SqlTokenStream::tokenize('ON DELETE RESTRICT', SqliteLexerProfile::create())->significantTokens(), 'DELETE'));
        self::assertSame(\ZtdQuery\Schema\ReferentialAction::SetDefault, $parser->action(SqlTokenStream::tokenize('ON UPDATE SET DEFAULT', SqliteLexerProfile::create())->significantTokens(), 'UPDATE'));
        self::assertSame(\ZtdQuery\Schema\ReferentialAction::NoAction, $parser->action(SqlTokenStream::tokenize('ON UPDATE SET', SqliteLexerProfile::create())->significantTokens(), 'UPDATE'));
        self::assertSame(\ZtdQuery\Schema\ReferentialAction::NoAction, $parser->action([], 'DELETE'));
    }
