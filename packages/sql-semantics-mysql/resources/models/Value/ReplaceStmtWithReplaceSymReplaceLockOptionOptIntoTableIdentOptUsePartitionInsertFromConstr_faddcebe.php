 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\ReplaceStmtWithReplaceSymReplaceLockOptionOptIntoTableIdentOptUsePartitionInsertFromConstr_faddcebe $value): string => \SqlSemantics\Statement\Writer::render($value);
...
final class ReplaceStmtWithReplaceSymReplaceLockOptionOptIntoTableIdentOptUsePartitionInsertFromConstr_faddcebe implements \SqlSemantics\Statement\Model\MySql\Role\EvSqlStmtForm, \SqlSemantics\Statement\Model\MySql\Role\EvSqlStmtInnerForm, \SqlSemantics\Statement\Model\MySql\Role\ExplainableCommandForm, \SqlSemantics\Statement\Model\MySql\Role\ExplainableStmtForm, \SqlSemantics\Statement\Model\MySql\Role\ReplaceStmtForm, \SqlSemantics\Statement\Model\MySql\Role\SimpleStatementForm, \SqlSemantics\Statement\Model\MySql\Role\SimpleStatementOrBeginForm, \SqlSemantics\Statement\Model\MySql\Role\SpProcStmtForm, \SqlSemantics\Statement\Model\MySql\Role\SpProcStmtStatementForm, \SqlSemantics\Statement\Model\MySql\Role\StatementForm, \SqlSemantics\Statement\Model\MySql\Role\StoredRoutineBodyForm, \SqlSemantics\Statement\Model\MySql\Role\VerbClauseForm, \SqlSemantics\Statement\Command
{
    ...
    {
        return new self($replaceLockOption, $this->optInto, $this->tableIdent, $this->optUsePartition, $this->insertFromConstructor, $this->comments);
    }
    ...
    {
        return new self($this->replaceLockOption, $optInto, $this->tableIdent, $this->optUsePartition, $this->insertFromConstructor, $this->comments);
    }
    ...
    {
        return new self($this->replaceLockOption, $this->optInto, $tableIdent, $this->optUsePartition, $this->insertFromConstructor, $this->comments);
    }
    ...
    {
        return new self($this->replaceLockOption, $this->optInto, $this->tableIdent, $optUsePartition, $this->insertFromConstructor, $this->comments);
    }
    ...
    {
        return new self($this->replaceLockOption, $this->optInto, $this->tableIdent, $this->optUsePartition, $insertFromConstructor, $this->comments);
    }
    ...
    {
        return new self($this->replaceLockOption, $this->optInto, $this->tableIdent, $this->optUsePartition, $this->insertFromConstructor, $comments);
    }
}
