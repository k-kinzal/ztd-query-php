 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\SimpleExprWithSimpleExpr_deab3046 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
