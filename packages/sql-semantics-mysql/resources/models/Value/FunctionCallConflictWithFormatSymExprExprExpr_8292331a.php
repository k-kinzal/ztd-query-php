 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\FunctionCallConflictWithFormatSymExprExprExpr_8292331a $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
