 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\QuerySpecificationWithSelectSymSelectOptionsSelectItemListOptFromClauseOptWhereClauseOptGroupClau_1e0687be $value): string => \SqlSemantics\Statement\Writer::render($value);
...
final class QuerySpecificationWithSelectSymSelectOptionsSelectItemListOptFromClauseOptWhereClauseOptGroupClau_1e0687be implements \SqlSemantics\Statement\Model\MySql\Role\QueryExpressionBodyForm, \SqlSemantics\Statement\Model\MySql\Role\QueryPrimaryForm, \SqlSemantics\Statement\Model\MySql\Role\QuerySpecificationForm, \SqlSemantics\Statement\Model\MySql\Role\SubselectForm
{
    ...
    {
        return new self($options, $this->projections, $this->from, $this->where, $this->optGroupClause, $this->optHavingClause, $this->optWindowClause, $this->optQualifyClause, $this->comments);
    }
    ...
    {
        return new self($this->options, $projections, $this->from, $this->where, $this->optGroupClause, $this->optHavingClause, $this->optWindowClause, $this->optQualifyClause, $this->comments);
    }
    ...
    {
        return new self($this->options, $this->projections, $from, $this->where, $this->optGroupClause, $this->optHavingClause, $this->optWindowClause, $this->optQualifyClause, $this->comments);
    }
    ...
    {
        return new self($this->options, $this->projections, $this->from, $where, $this->optGroupClause, $this->optHavingClause, $this->optWindowClause, $this->optQualifyClause, $this->comments);
    }
    ...
    {
        return new self($this->options, $this->projections, $this->from, $this->where, $optGroupClause, $this->optHavingClause, $this->optWindowClause, $this->optQualifyClause, $this->comments);
    }
    ...
    {
        return new self($this->options, $this->projections, $this->from, $this->where, $this->optGroupClause, $optHavingClause, $this->optWindowClause, $this->optQualifyClause, $this->comments);
    }
    ...
    {
        return new self($this->options, $this->projections, $this->from, $this->where, $this->optGroupClause, $this->optHavingClause, $optWindowClause, $this->optQualifyClause, $this->comments);
    }
    ...
    {
        return new self($this->options, $this->projections, $this->from, $this->where, $this->optGroupClause, $this->optHavingClause, $this->optWindowClause, $optQualifyClause, $this->comments);
    }
    ...
    {
        return new self($this->options, $this->projections, $this->from, $this->where, $this->optGroupClause, $this->optHavingClause, $this->optWindowClause, $this->optQualifyClause, $comments);
    }
}
