 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\SimpleExprWithSimpleIdentJsonSeparatorSymTextStringLiteral_79d5e28c $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
