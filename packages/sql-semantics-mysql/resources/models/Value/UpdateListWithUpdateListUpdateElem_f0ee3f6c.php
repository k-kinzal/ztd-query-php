...
final class UpdateListWithUpdateListUpdateElem_f0ee3f6c implements \SqlSemantics\Statement\Model\MySql\Role\UpdateListForm
{
    ...
    {
        return new self($updateList, $this->updateElem, $this->comments);
    }
    ...
    {
        return new self($this->updateList, $updateElem, $this->comments);
    }
    ...
    {
        return new self($this->updateList, $this->updateElem, $comments);
    }
}
