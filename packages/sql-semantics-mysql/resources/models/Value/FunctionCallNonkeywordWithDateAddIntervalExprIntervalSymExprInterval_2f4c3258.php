 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\FunctionCallNonkeywordWithDateAddIntervalExprIntervalSymExprInterval_2f4c3258 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
