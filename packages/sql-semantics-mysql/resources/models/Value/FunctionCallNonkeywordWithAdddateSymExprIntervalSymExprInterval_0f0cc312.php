 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\FunctionCallNonkeywordWithAdddateSymExprIntervalSymExprInterval_0f0cc312 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
