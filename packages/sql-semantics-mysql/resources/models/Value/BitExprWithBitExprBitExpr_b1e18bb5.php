 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\BitExprWithBitExprBitExpr_b1e18bb5 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
