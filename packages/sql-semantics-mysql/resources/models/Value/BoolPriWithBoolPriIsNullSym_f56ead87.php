 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\BoolPriWithBoolPriIsNullSym_f56ead87 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
