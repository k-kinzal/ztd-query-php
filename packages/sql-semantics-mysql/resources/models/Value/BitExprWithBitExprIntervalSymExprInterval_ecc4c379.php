 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\BitExprWithBitExprIntervalSymExprInterval_ecc4c379 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
