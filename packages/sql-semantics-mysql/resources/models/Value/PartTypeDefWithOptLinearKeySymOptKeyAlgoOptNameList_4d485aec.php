...
final class PartTypeDefWithOptLinearKeySymOptKeyAlgoOptNameList_4d485aec implements \SqlSemantics\Statement\Model\MySql\Role\PartTypeDefForm
{
    ...
    {
        return new self($optLinear, $this->optKeyAlgo, $this->optNameList, $this->comments);
    }
    ...
    {
        return new self($this->optLinear, $optKeyAlgo, $this->optNameList, $this->comments);
    }
    ...
    {
        return new self($this->optLinear, $this->optKeyAlgo, $optNameList, $this->comments);
    }
    ...
    {
        return new self($this->optLinear, $this->optKeyAlgo, $this->optNameList, $comments);
    }
}
