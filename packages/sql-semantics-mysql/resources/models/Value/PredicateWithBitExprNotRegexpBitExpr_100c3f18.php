 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\PredicateWithBitExprNotRegexpBitExpr_100c3f18 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
