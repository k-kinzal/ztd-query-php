 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\PredicateWithBitExprNotInSymExpr_fb07a40f $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
