 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\FunctionCallNonkeywordWithSubstringExprExpr_4fe7f0cd $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
