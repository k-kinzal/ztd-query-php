 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\BoolPriWithBoolPriCompOpAllOrAnySubselect_ff3558ec $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
