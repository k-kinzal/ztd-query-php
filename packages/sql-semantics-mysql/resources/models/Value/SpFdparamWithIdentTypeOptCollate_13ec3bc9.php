...
final class SpFdparamWithIdentTypeOptCollate_13ec3bc9 implements \SqlSemantics\Statement\Model\MySql\Role\SpFdparamForm, \SqlSemantics\Statement\Model\MySql\Role\SpFdparamListForm, \SqlSemantics\Statement\Model\MySql\Role\SpFdparamsForm
{
    ...
    {
        return new self($ident, $this->type, $this->optCollate, $this->comments);
    }
    ...
    {
        return new self($this->ident, $type, $this->optCollate, $this->comments);
    }
    ...
    {
        return new self($this->ident, $this->type, $optCollate, $this->comments);
    }
    ...
    {
        return new self($this->ident, $this->type, $this->optCollate, $comments);
    }
}
