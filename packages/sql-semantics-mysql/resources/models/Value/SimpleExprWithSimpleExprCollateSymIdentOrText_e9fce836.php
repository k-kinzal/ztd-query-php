 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\SimpleExprWithSimpleExprCollateSymIdentOrText_e9fce836 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
