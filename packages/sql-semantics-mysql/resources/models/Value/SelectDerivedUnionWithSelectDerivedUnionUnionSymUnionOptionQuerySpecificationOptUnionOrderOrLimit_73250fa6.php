...
final class SelectDerivedUnionWithSelectDerivedUnionUnionSymUnionOptionQuerySpecificationOptUnionOrderOrLimit_73250fa6 implements \SqlSemantics\Statement\Model\MySql\Role\SelectDerivedUnionForm
{
    ...
    {
        return new self($selectDerivedUnion, $this->unionOption, $this->query, $this->optUnionOrderOrLimit, $this->comments);
    }
    ...
    {
        return new self($this->selectDerivedUnion, $unionOption, $this->query, $this->optUnionOrderOrLimit, $this->comments);
    }
    ...
    {
        return new self($this->selectDerivedUnion, $this->unionOption, $query, $this->optUnionOrderOrLimit, $this->comments);
    }
    ...
    {
        return new self($this->selectDerivedUnion, $this->unionOption, $this->query, $optUnionOrderOrLimit, $this->comments);
    }
    ...
    {
        return new self($this->selectDerivedUnion, $this->unionOption, $this->query, $this->optUnionOrderOrLimit, $comments);
    }
}
