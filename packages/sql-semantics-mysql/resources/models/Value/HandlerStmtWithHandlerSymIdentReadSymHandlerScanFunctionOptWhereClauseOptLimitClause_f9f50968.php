 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\HandlerStmtWithHandlerSymIdentReadSymHandlerScanFunctionOptWhereClauseOptLimitClause_f9f50968 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
