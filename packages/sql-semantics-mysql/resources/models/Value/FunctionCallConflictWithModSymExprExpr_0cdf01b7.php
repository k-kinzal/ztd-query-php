 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\FunctionCallConflictWithModSymExprExpr_0cdf01b7 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
