 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\FunctionCallNonkeywordWithGetFormatDateTimeTypeExpr_451c5d3d $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
