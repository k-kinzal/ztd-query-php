...
final class CreateIndexStmtWithCreateFulltextSymIndexSymIdentOnSymTableIdentKeyListWithExpressionOptFullte_2d5d6d89 implements \SqlSemantics\Statement\Model\MySql\Role\CreateIndexStmtForm, \SqlSemantics\Statement\Model\MySql\Role\EvSqlStmtForm, \SqlSemantics\Statement\Model\MySql\Role\EvSqlStmtInnerForm, \SqlSemantics\Statement\Model\MySql\Role\SimpleStatementForm, \SqlSemantics\Statement\Model\MySql\Role\SimpleStatementOrBeginForm, \SqlSemantics\Statement\Model\MySql\Role\SpProcStmtForm, \SqlSemantics\Statement\Model\MySql\Role\SpProcStmtStatementForm, \SqlSemantics\Statement\Model\MySql\Role\StoredRoutineBodyForm, \SqlSemantics\Statement\Command
{
    ...
    {
        return new self($ident, $this->tableIdent, $this->keyListWithExpression, $this->optFulltextIndexOptions, $this->optIndexLockAndAlgorithm, $this->comments);
    }
    ...
    {
        return new self($this->ident, $tableIdent, $this->keyListWithExpression, $this->optFulltextIndexOptions, $this->optIndexLockAndAlgorithm, $this->comments);
    }
    ...
    {
        return new self($this->ident, $this->tableIdent, $keyListWithExpression, $this->optFulltextIndexOptions, $this->optIndexLockAndAlgorithm, $this->comments);
    }
    ...
    {
        return new self($this->ident, $this->tableIdent, $this->keyListWithExpression, $optFulltextIndexOptions, $this->optIndexLockAndAlgorithm, $this->comments);
    }
    ...
    {
        return new self($this->ident, $this->tableIdent, $this->keyListWithExpression, $this->optFulltextIndexOptions, $optIndexLockAndAlgorithm, $this->comments);
    }
    ...
    {
        return new self($this->ident, $this->tableIdent, $this->keyListWithExpression, $this->optFulltextIndexOptions, $this->optIndexLockAndAlgorithm, $comments);
    }
}
