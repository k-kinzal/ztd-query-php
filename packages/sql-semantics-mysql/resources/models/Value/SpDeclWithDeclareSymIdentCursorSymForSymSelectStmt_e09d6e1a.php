...
final class SpDeclWithDeclareSymIdentCursorSymForSymSelectStmt_e09d6e1a implements \SqlSemantics\Statement\Model\MySql\Role\SpDeclForm
{
    ...
    {
        return new self($ident, $this->selectStmt, $this->comments);
    }
    ...
    {
        return new self($this->ident, $selectStmt, $this->comments);
    }
    ...
    {
        return new self($this->ident, $this->selectStmt, $comments);
    }
}
