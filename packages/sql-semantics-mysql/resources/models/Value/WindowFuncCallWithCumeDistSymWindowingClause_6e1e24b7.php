 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\WindowFuncCallWithCumeDistSymWindowingClause_6e1e24b7 $value): string => \SqlSemantics\Statement\Writer::render($value);
