 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\PredicateWithBitExprInSymExprExprList_1b9e18a4 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
