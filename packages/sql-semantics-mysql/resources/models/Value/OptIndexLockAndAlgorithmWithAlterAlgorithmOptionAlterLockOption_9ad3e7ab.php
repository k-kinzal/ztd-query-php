 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\OptIndexLockAndAlgorithmWithAlterAlgorithmOptionAlterLockOption_9ad3e7ab $value): string => \SqlSemantics\Statement\Writer::render($value);
...
final class OptIndexLockAndAlgorithmWithAlterAlgorithmOptionAlterLockOption_9ad3e7ab implements \SqlSemantics\Statement\Model\MySql\Role\OptIndexLockAndAlgorithmForm
{
    ...
    {
        return new self($alterAlgorithmOption, $this->alterLockOption, $this->comments);
    }
    ...
    {
        return new self($this->alterAlgorithmOption, $alterLockOption, $this->comments);
    }
    ...
    {
        return new self($this->alterAlgorithmOption, $this->alterLockOption, $comments);
    }
}
