 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\InstallStmtWithInstallSymPluginSymIdentSonameSymTextStringSys_0b23adc8 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
