...
final class RevokeCommandWithGrantPrivilegesOnOptTableGrantIdentFromGrantList_e0d2bee3 implements \SqlSemantics\Statement\Model\MySql\Role\RevokeCommandForm
{
    ...
    {
        return new self($grantPrivileges, $this->optTable, $this->grantIdent, $this->grantList, $this->comments);
    }
    ...
    {
        return new self($this->grantPrivileges, $optTable, $this->grantIdent, $this->grantList, $this->comments);
    }
    ...
    {
        return new self($this->grantPrivileges, $this->optTable, $grantIdent, $this->grantList, $this->comments);
    }
    ...
    {
        return new self($this->grantPrivileges, $this->optTable, $this->grantIdent, $grantList, $this->comments);
    }
    ...
    {
        return new self($this->grantPrivileges, $this->optTable, $this->grantIdent, $this->grantList, $comments);
    }
}
