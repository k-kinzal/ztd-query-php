...
final class StartOptionValueListWithPasswordForSymUserToSymRandomSymOptReplacePasswordOptRetainCurrentPassword_512cc013 implements \SqlSemantics\Statement\Model\MySql\Role\StartOptionValueListForm
{
    ...
    {
        return new self($user, $this->optReplacePassword, $this->optRetainCurrentPassword, $this->comments);
    }
    ...
    {
        return new self($this->user, $optReplacePassword, $this->optRetainCurrentPassword, $this->comments);
    }
    ...
    {
        return new self($this->user, $this->optReplacePassword, $optRetainCurrentPassword, $this->comments);
    }
    ...
    {
        return new self($this->user, $this->optReplacePassword, $this->optRetainCurrentPassword, $comments);
    }
}
