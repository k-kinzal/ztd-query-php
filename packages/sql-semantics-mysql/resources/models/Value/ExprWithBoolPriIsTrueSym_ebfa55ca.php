 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\ExprWithBoolPriIsTrueSym_ebfa55ca $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
