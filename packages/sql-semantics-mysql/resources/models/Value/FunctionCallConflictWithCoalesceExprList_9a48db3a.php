 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\FunctionCallConflictWithCoalesceExprList_9a48db3a $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
