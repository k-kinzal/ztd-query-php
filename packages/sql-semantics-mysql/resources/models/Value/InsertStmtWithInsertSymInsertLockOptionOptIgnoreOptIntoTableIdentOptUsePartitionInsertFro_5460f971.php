 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\InsertStmtWithInsertSymInsertLockOptionOptIgnoreOptIntoTableIdentOptUsePartitionInsertFro_5460f971 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
