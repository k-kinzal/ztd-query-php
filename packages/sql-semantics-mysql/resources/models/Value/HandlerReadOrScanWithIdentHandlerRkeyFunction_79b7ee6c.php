...
final class HandlerReadOrScanWithIdentHandlerRkeyFunction_79b7ee6c implements \SqlSemantics\Statement\Model\MySql\Role\HandlerReadOrScanForm
{
    ...
    {
        return new self($ident, $this->handlerRkeyFunction, $this->comments);
    }
    ...
    {
        return new self($this->ident, $handlerRkeyFunction, $this->comments);
    }
    ...
    {
        return new self($this->ident, $this->handlerRkeyFunction, $comments);
    }
}
