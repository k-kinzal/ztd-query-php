 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\ReplaceStmtWithReplaceReplaceLockOptionOptIntoTableIdentOptUsePartitionInsertFromSubquery_e8e1f26f $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
