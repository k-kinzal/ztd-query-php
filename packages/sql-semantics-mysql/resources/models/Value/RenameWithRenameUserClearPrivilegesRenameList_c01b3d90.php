...
final class RenameWithRenameUserClearPrivilegesRenameList_c01b3d90 implements \SqlSemantics\Statement\Model\MySql\Role\EvSqlStmtForm, \SqlSemantics\Statement\Model\MySql\Role\EvSqlStmtInnerForm, \SqlSemantics\Statement\Model\MySql\Role\RenameForm, \SqlSemantics\Statement\Model\MySql\Role\SimpleStatementForm, \SqlSemantics\Statement\Model\MySql\Role\SimpleStatementOrBeginForm, \SqlSemantics\Statement\Model\MySql\Role\SpProcStmtForm, \SqlSemantics\Statement\Model\MySql\Role\SpProcStmtStatementForm, \SqlSemantics\Statement\Model\MySql\Role\StatementForm, \SqlSemantics\Statement\Model\MySql\Role\StoredRoutineBodyForm, \SqlSemantics\Statement\Model\MySql\Role\VerbClauseForm, \SqlSemantics\Statement\Command
{
    ...
    {
        return new self($user, $this->clearPrivileges, $this->renameList, $this->comments);
    }
    ...
    {
        return new self($this->user, $clearPrivileges, $this->renameList, $this->comments);
    }
    ...
    {
        return new self($this->user, $this->clearPrivileges, $renameList, $this->comments);
    }
    ...
    {
        return new self($this->user, $this->clearPrivileges, $this->renameList, $comments);
    }
}
