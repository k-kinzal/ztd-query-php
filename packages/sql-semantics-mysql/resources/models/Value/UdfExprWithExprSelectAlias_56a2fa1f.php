...
final class UdfExprWithExprSelectAlias_56a2fa1f implements \SqlSemantics\Statement\Model\MySql\Role\OptUdfExprListForm, \SqlSemantics\Statement\Model\MySql\Role\UdfExprForm, \SqlSemantics\Statement\Model\MySql\Role\UdfExprListForm
{
    ...
    {
        return new self($expr, $this->selectAlias, $this->comments);
    }
    ...
    {
        return new self($this->expr, $selectAlias, $this->comments);
    }
    ...
    {
        return new self($this->expr, $this->selectAlias, $comments);
    }
}
