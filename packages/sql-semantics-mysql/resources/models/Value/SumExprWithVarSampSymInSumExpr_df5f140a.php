 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\SumExprWithVarSampSymInSumExpr_df5f140a $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
