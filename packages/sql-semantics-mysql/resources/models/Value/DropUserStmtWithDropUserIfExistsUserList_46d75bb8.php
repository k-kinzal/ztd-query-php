...
final class DropUserStmtWithDropUserIfExistsUserList_46d75bb8 implements \SqlSemantics\Statement\Model\MySql\Role\DropUserStmtForm, \SqlSemantics\Statement\Model\MySql\Role\EvSqlStmtForm, \SqlSemantics\Statement\Model\MySql\Role\EvSqlStmtInnerForm, \SqlSemantics\Statement\Model\MySql\Role\SimpleStatementForm, \SqlSemantics\Statement\Model\MySql\Role\SimpleStatementOrBeginForm, \SqlSemantics\Statement\Model\MySql\Role\SpProcStmtForm, \SqlSemantics\Statement\Model\MySql\Role\SpProcStmtStatementForm, \SqlSemantics\Statement\Model\MySql\Role\StoredRoutineBodyForm, \SqlSemantics\Statement\Command
{
    ...
    {
        return new self($user, $this->ifExists, $this->userList, $this->comments);
    }
    ...
    {
        return new self($this->user, $ifExists, $this->userList, $this->comments);
    }
    ...
    {
        return new self($this->user, $this->ifExists, $userList, $this->comments);
    }
    ...
    {
        return new self($this->user, $this->ifExists, $this->userList, $comments);
    }
}
