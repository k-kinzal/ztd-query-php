 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\FunctionCallKeywordWithCurrentUserOptionalBraces_a1a8fb72 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
