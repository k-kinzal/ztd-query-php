 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\StandaloneAlterCommandsWithAnalyzeSymPartitionSymOptNoWriteToBinlogAllOrAltPartNameList_f5f199cd $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
