 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\BitExprWithBitExprDivSymBitExpr_a81ee65d $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
