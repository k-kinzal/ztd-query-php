 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\CreateTableOptionWithEngineSymOptEqualIdentOrText_2c48feae $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
