 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\SumExprWithMaxSymDistinctInSumExprOptWindowingClause_6821fbec $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
