 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\CreateTableOptionWithChecksumSymOptEqualUlongNum_0a98c695 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
