...
final class OptSubPartWithSubpartitionSymByOptLinearKeySymOptKeyAlgoNameListOptNumSubparts_c9746b5c implements \SqlSemantics\Statement\Model\MySql\Role\OptSubPartForm
{
    ...
    {
        return new self($optLinear, $this->optKeyAlgo, $this->nameList, $this->optNumSubparts, $this->comments);
    }
    ...
    {
        return new self($this->optLinear, $optKeyAlgo, $this->nameList, $this->optNumSubparts, $this->comments);
    }
    ...
    {
        return new self($this->optLinear, $this->optKeyAlgo, $nameList, $this->optNumSubparts, $this->comments);
    }
    ...
    {
        return new self($this->optLinear, $this->optKeyAlgo, $this->nameList, $optNumSubparts, $this->comments);
    }
    ...
    {
        return new self($this->optLinear, $this->optKeyAlgo, $this->nameList, $this->optNumSubparts, $comments);
    }
}
