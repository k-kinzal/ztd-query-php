 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\ReplaceStmtWithReplaceReplaceLockOptionOptIntoTableIdentOptUsePartitionSetUpdateList_9e9fee32 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
