 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\SimpleIdentQWithIdentIdent_591fa226 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
