...
final class FieldIdentWithIdentIdentIdent_5fc0a9e3 implements \SqlSemantics\Statement\Model\MySql\Role\FieldIdentForm, \SqlSemantics\Statement\Model\MySql\Role\OptIdentForm, \SqlSemantics\Statement\Model\MySql\Role\OptIndexNameAndTypeForm
{
    ...
    {
        return new self($ident, $this->ident2, $this->ident3, $this->comments);
    }
    ...
    {
        return new self($this->ident, $ident2, $this->ident3, $this->comments);
    }
    ...
    {
        return new self($this->ident, $this->ident2, $ident3, $this->comments);
    }
    ...
    {
        return new self($this->ident, $this->ident2, $this->ident3, $comments);
    }
}
