...
final class TablespaceOptionListWithTablespaceOptionListOptCommaTablespaceOption_2bcb9697 implements \SqlSemantics\Statement\Model\MySql\Role\OptTablespaceOptionsForm, \SqlSemantics\Statement\Model\MySql\Role\TablespaceOptionListForm
{
    ...
    {
        return new self($tablespaceOptionList, $this->optComma, $this->tablespaceOption, $this->comments);
    }
    ...
    {
        return new self($this->tablespaceOptionList, $optComma, $this->tablespaceOption, $this->comments);
    }
    ...
    {
        return new self($this->tablespaceOptionList, $this->optComma, $tablespaceOption, $this->comments);
    }
    ...
    {
        return new self($this->tablespaceOptionList, $this->optComma, $this->tablespaceOption, $comments);
    }
}
