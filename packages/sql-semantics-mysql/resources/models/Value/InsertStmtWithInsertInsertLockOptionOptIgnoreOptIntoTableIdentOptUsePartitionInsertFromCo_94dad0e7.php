 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\InsertStmtWithInsertInsertLockOptionOptIgnoreOptIntoTableIdentOptUsePartitionInsertFromCo_94dad0e7 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
