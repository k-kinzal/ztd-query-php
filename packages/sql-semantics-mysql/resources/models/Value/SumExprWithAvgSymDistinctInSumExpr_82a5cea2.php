 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\SumExprWithAvgSymDistinctInSumExpr_82a5cea2 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
