 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\InsertStmtWithInsertInsertLockOptionOptIgnoreOptIntoTableIdentOptUsePartitionInsertFromSu_5230158a $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
