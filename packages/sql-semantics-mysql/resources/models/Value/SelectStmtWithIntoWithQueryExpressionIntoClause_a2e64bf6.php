 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\SelectStmtWithIntoWithQueryExpressionIntoClause_a2e64bf6 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
