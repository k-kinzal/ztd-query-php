...
final class PreloadKeysWithTableIdentOptCacheKeyListOptIgnoreLeaves_e52fbc81 implements \SqlSemantics\Statement\Model\MySql\Role\PreloadKeysForm, \SqlSemantics\Statement\Model\MySql\Role\PreloadListForm, \SqlSemantics\Statement\Model\MySql\Role\PreloadListOrPartsForm
{
    ...
    {
        return new self($tableIdent, $this->optCacheKeyList, $this->optIgnoreLeaves, $this->comments);
    }
    ...
    {
        return new self($this->tableIdent, $optCacheKeyList, $this->optIgnoreLeaves, $this->comments);
    }
    ...
    {
        return new self($this->tableIdent, $this->optCacheKeyList, $optIgnoreLeaves, $this->comments);
    }
    ...
    {
        return new self($this->tableIdent, $this->optCacheKeyList, $this->optIgnoreLeaves, $comments);
    }
}
