 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\RevokeCommandWithGrantPrivilegesOnProcedureSymGrantIdentFromUserList_31fe5d6e $value): string => \SqlSemantics\Statement\Writer::render($value);
 *     $write instanceof \Closure // => true
 */
final class RevokeCommandWithGrantPrivilegesOnProcedureSymGrantIdentFromUserList_31fe5d6e implements \SqlSemantics\Statement\Model\MySql\Role\RevokeCommandForm
{
    ...
    {
        return new self($grantPrivileges, $this->grantIdent, $this->userList, $this->comments);
    }
    ...
    {
        return new self($this->grantPrivileges, $grantIdent, $this->userList, $this->comments);
    }
    ...
    {
        return new self($this->grantPrivileges, $this->grantIdent, $userList, $this->comments);
    }
    ...
    {
        return new self($this->grantPrivileges, $this->grantIdent, $this->userList, $comments);
    }
}
