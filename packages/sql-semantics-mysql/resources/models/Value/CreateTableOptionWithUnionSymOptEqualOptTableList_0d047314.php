 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\CreateTableOptionWithUnionSymOptEqualOptTableList_0d047314 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
