 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\DropWithDropUserClearPrivilegesUserList_fb762bb8 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
