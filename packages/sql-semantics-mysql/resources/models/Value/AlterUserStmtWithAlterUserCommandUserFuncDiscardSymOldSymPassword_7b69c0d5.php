 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\AlterUserStmtWithAlterUserCommandUserFuncDiscardSymOldSymPassword_7b69c0d5 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
