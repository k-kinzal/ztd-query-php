 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\AlterListItemWithAlterConstraintIdentConstraintEnforcement_d364439b $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
