...
final class SingleTableWithTableIdentOptUsePartitionOptTableAliasOptKeyDefinition_e33dd17f implements \SqlSemantics\Statement\Model\MySql\Role\DerivedTableListForm, \SqlSemantics\Statement\Model\MySql\Role\EscTableRefForm, \SqlSemantics\Statement\Model\MySql\Role\EscTableReferenceForm, \SqlSemantics\Statement\Model\MySql\Role\FromTablesForm, \SqlSemantics\Statement\Model\MySql\Role\JoinTableListForm, \SqlSemantics\Statement\Model\MySql\Role\SelectDerivedForm, \SqlSemantics\Statement\Model\MySql\Role\SingleTableForm, \SqlSemantics\Statement\Model\MySql\Role\TableFactorForm, \SqlSemantics\Statement\Model\MySql\Role\TableRefForm, \SqlSemantics\Statement\Model\MySql\Role\TableReferenceForm, \SqlSemantics\Statement\Model\MySql\Role\TableReferenceListForm
{
    ...
    {
        return new self($tableIdent, $this->optUsePartition, $this->optTableAlias, $this->optKeyDefinition, $this->comments);
    }
    ...
    {
        return new self($this->tableIdent, $optUsePartition, $this->optTableAlias, $this->optKeyDefinition, $this->comments);
    }
    ...
    {
        return new self($this->tableIdent, $this->optUsePartition, $optTableAlias, $this->optKeyDefinition, $this->comments);
    }
    ...
    {
        return new self($this->tableIdent, $this->optUsePartition, $this->optTableAlias, $optKeyDefinition, $this->comments);
    }
    ...
    {
        return new self($this->tableIdent, $this->optUsePartition, $this->optTableAlias, $this->optKeyDefinition, $comments);
    }
}
