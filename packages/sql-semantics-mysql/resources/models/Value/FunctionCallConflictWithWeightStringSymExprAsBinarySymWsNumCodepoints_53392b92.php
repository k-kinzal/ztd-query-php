 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\FunctionCallConflictWithWeightStringSymExprAsBinarySymWsNumCodepoints_53392b92 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
