 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\InExpressionUserVariableAssignmentWithIdentOrTextSetVarExpr_35c1d0bd $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
