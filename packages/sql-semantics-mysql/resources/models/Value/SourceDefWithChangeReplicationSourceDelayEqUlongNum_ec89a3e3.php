...
final class SourceDefWithChangeReplicationSourceDelayEqUlongNum_ec89a3e3 implements \SqlSemantics\Statement\Model\MySql\Role\SourceDefForm, \SqlSemantics\Statement\Model\MySql\Role\SourceDefsForm
{
    ...
    {
        return new self($changeReplicationSourceDelay, $this->ulongNum, $this->comments);
    }
    ...
    {
        return new self($this->changeReplicationSourceDelay, $ulongNum, $this->comments);
    }
    ...
    {
        return new self($this->changeReplicationSourceDelay, $this->ulongNum, $comments);
    }
}
