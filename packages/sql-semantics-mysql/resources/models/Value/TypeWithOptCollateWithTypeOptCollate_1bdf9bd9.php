...
final class TypeWithOptCollateWithTypeOptCollate_1bdf9bd9 implements \SqlSemantics\Statement\Model\MySql\Role\TypeWithOptCollateForm
{
    ...
    {
        return new self($type, $this->optCollate, $this->comments);
    }
    ...
    {
        return new self($this->type, $optCollate, $this->comments);
    }
    ...
    {
        return new self($this->type, $this->optCollate, $comments);
    }
}
