 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\TextLiteralWithTextLiteralTextStringLiteral_95576efb $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
