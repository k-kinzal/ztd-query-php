 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\CreateTableOptionWithStatsAutoRecalcSymOptEqualUlongNum_ad529de2 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
