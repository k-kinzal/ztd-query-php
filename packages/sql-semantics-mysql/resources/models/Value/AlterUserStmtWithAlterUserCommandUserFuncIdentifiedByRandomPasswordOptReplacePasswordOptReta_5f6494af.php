...
final class AlterUserStmtWithAlterUserCommandUserFuncIdentifiedByRandomPasswordOptReplacePasswordOptReta_5f6494af implements \SqlSemantics\Statement\Model\MySql\Role\AlterUserStmtForm, \SqlSemantics\Statement\Model\MySql\Role\EvSqlStmtForm, \SqlSemantics\Statement\Model\MySql\Role\EvSqlStmtInnerForm, \SqlSemantics\Statement\Model\MySql\Role\SimpleStatementForm, \SqlSemantics\Statement\Model\MySql\Role\SimpleStatementOrBeginForm, \SqlSemantics\Statement\Model\MySql\Role\SpProcStmtForm, \SqlSemantics\Statement\Model\MySql\Role\SpProcStmtStatementForm, \SqlSemantics\Statement\Model\MySql\Role\StoredRoutineBodyForm, \SqlSemantics\Statement\Command
{
    ...
    {
        return new self($alterUserCommand, $this->userFunc, $this->identifiedByRandomPassword, $this->optReplacePassword, $this->optRetainCurrentPassword, $this->comments);
    }
    ...
    {
        return new self($this->alterUserCommand, $userFunc, $this->identifiedByRandomPassword, $this->optReplacePassword, $this->optRetainCurrentPassword, $this->comments);
    }
    ...
    {
        return new self($this->alterUserCommand, $this->userFunc, $identifiedByRandomPassword, $this->optReplacePassword, $this->optRetainCurrentPassword, $this->comments);
    }
    ...
    {
        return new self($this->alterUserCommand, $this->userFunc, $this->identifiedByRandomPassword, $optReplacePassword, $this->optRetainCurrentPassword, $this->comments);
    }
    ...
    {
        return new self($this->alterUserCommand, $this->userFunc, $this->identifiedByRandomPassword, $this->optReplacePassword, $optRetainCurrentPassword, $this->comments);
    }
    ...
    {
        return new self($this->alterUserCommand, $this->userFunc, $this->identifiedByRandomPassword, $this->optReplacePassword, $this->optRetainCurrentPassword, $comments);
    }
}
