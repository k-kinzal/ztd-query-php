 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\FunctionCallConflictWithQuarterSymExpr_27ac48ac $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
