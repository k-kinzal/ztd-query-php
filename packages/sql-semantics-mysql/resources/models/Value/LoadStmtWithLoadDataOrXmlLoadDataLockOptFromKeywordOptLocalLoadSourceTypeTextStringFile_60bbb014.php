 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\LoadStmtWithLoadDataOrXmlLoadDataLockOptFromKeywordOptLocalLoadSourceTypeTextStringFile_60bbb014 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
