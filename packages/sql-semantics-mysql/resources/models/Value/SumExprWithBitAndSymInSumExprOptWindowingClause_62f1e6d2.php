 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\SumExprWithBitAndSymInSumExprOptWindowingClause_62f1e6d2 $value): string => \SqlSemantics\Statement\Writer::render($value);
