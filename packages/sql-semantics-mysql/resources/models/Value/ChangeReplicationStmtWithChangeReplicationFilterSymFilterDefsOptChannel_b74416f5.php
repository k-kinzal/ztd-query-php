 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\ChangeReplicationStmtWithChangeReplicationFilterSymFilterDefsOptChannel_b74416f5 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
