 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\FunctionCallConflictWithWeightStringSymExprAsCharSymWsNumCodepoints_3ab7b46c $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
