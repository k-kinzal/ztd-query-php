...
final class StatementInformationWithStatementInformationStatementInformationItem_4bbc08fc implements \SqlSemantics\Statement\Model\MySql\Role\DiagnosticsInformationForm, \SqlSemantics\Statement\Model\MySql\Role\StatementInformationForm
{
    ...
    {
        return new self($statementInformation, $this->statementInformationItem, $this->comments);
    }
    ...
    {
        return new self($this->statementInformation, $statementInformationItem, $this->comments);
    }
    ...
    {
        return new self($this->statementInformation, $this->statementInformationItem, $comments);
    }
}
