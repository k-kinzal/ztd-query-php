 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\FunctionCallKeywordWithMinuteSymExpr_da407496 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
