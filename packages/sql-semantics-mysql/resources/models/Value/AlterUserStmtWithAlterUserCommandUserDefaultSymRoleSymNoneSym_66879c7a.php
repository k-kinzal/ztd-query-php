 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\AlterUserStmtWithAlterUserCommandUserDefaultSymRoleSymNoneSym_66879c7a $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
