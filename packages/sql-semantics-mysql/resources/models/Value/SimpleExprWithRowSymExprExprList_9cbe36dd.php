 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\SimpleExprWithRowSymExprExprList_9cbe36dd $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
