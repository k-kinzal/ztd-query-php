...
final class TransactionCharacteristicsWithTransactionAccessModeIsolationLevel_954fbcaf implements \SqlSemantics\Statement\Model\MySql\Role\TransactionCharacteristicsForm
{
    ...
    {
        return new self($transactionAccessMode, $this->isolationLevel, $this->comments);
    }
    ...
    {
        return new self($this->transactionAccessMode, $isolationLevel, $this->comments);
    }
    ...
    {
        return new self($this->transactionAccessMode, $this->isolationLevel, $comments);
    }
}
