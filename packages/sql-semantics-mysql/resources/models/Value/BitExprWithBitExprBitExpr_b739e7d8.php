 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\BitExprWithBitExprBitExpr_b739e7d8 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
