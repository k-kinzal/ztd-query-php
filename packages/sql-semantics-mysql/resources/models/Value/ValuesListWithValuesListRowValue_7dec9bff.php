...
final class ValuesListWithValuesListRowValue_7dec9bff implements \SqlSemantics\Statement\Model\MySql\Role\ValuesListForm
{
    ...
    {
        return new self($valuesList, $this->rowValue, $this->comments);
    }
    ...
    {
        return new self($this->valuesList, $rowValue, $this->comments);
    }
    ...
    {
        return new self($this->valuesList, $this->rowValue, $comments);
    }
}
