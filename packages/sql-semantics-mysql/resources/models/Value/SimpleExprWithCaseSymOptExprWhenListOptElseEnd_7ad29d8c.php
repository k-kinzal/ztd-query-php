 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\SimpleExprWithCaseSymOptExprWhenListOptElseEnd_7ad29d8c $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
