 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\SumExprWithMinSymInSumExpr_a79798ae $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
