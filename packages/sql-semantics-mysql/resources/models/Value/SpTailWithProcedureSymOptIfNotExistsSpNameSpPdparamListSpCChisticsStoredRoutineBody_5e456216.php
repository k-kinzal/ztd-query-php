...
final class SpTailWithProcedureSymOptIfNotExistsSpNameSpPdparamListSpCChisticsStoredRoutineBody_5e456216 implements \SqlSemantics\Statement\Model\MySql\Role\DefinerTailForm, \SqlSemantics\Statement\Model\MySql\Role\NoDefinerTailForm, \SqlSemantics\Statement\Model\MySql\Role\SpTailForm
{
    ...
    {
        return new self($optIfNotExists, $this->spName, $this->spPdparamList, $this->spCChistics, $this->storedRoutineBody, $this->comments);
    }
    ...
    {
        return new self($this->optIfNotExists, $spName, $this->spPdparamList, $this->spCChistics, $this->storedRoutineBody, $this->comments);
    }
    ...
    {
        return new self($this->optIfNotExists, $this->spName, $spPdparamList, $this->spCChistics, $this->storedRoutineBody, $this->comments);
    }
    ...
    {
        return new self($this->optIfNotExists, $this->spName, $this->spPdparamList, $spCChistics, $this->storedRoutineBody, $this->comments);
    }
    ...
    {
        return new self($this->optIfNotExists, $this->spName, $this->spPdparamList, $this->spCChistics, $storedRoutineBody, $this->comments);
    }
    ...
    {
        return new self($this->optIfNotExists, $this->spName, $this->spPdparamList, $this->spCChistics, $this->storedRoutineBody, $comments);
    }
}
