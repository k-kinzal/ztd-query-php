...
final class LineTermListWithLineTermListLineTerm_3c14dca0 implements \SqlSemantics\Statement\Model\MySql\Role\LineTermListForm
{
    ...
    {
        return new self($lineTermList, $this->lineTerm, $this->comments);
    }
    ...
    {
        return new self($this->lineTermList, $lineTerm, $this->comments);
    }
    ...
    {
        return new self($this->lineTermList, $this->lineTerm, $comments);
    }
}
