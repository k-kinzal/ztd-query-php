...
final class PreloadKeysPartsWithTableIdentAdmPartitionCacheKeysSpecOptIgnoreLeaves_0f5ae70c implements \SqlSemantics\Statement\Model\MySql\Role\PreloadKeysPartsForm, \SqlSemantics\Statement\Model\MySql\Role\PreloadListOrPartsForm
{
    ...
    {
        return new self($tableIdent, $this->admPartition, $this->cacheKeysSpec, $this->optIgnoreLeaves, $this->comments);
    }
    ...
    {
        return new self($this->tableIdent, $admPartition, $this->cacheKeysSpec, $this->optIgnoreLeaves, $this->comments);
    }
    ...
    {
        return new self($this->tableIdent, $this->admPartition, $cacheKeysSpec, $this->optIgnoreLeaves, $this->comments);
    }
    ...
    {
        return new self($this->tableIdent, $this->admPartition, $this->cacheKeysSpec, $optIgnoreLeaves, $this->comments);
    }
    ...
    {
        return new self($this->tableIdent, $this->admPartition, $this->cacheKeysSpec, $this->optIgnoreLeaves, $comments);
    }
}
