 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\CreateTableStmtWithCreateOptTemporaryTableSymOptIfNotExistsTableIdentLikeTableIdent_6eac2bcb $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
