 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\SimpleExprWithConvertSymExprCastType_cc833c17 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
