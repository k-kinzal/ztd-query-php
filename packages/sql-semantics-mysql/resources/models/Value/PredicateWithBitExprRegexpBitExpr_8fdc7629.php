 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\PredicateWithBitExprRegexpBitExpr_8fdc7629 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
