 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\TableReferenceListParensWithTableReferenceListParens_aadf1d5e $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
