 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\FunctionCallKeywordWithJsonValueSymSimpleExprTextLiteralOptReturningTypeOptOnEmptyOrError_5be209a3 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
