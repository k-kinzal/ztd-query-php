 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\FunctionCallKeywordWithHourSymExpr_ae841a41 $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
