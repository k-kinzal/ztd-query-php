 ...
 *     $write = static fn (\SqlSemantics\Statement\Model\MySql\Value\CreateTableOptionWithKeyBlockSizeOptEqualUlongNum_c6c2909f $value): string => (new \SqlSemantics\Statement\Statement($value))->toString();
