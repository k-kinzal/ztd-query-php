...
final class GrantCommandWithProxySymOnUserToSymGrantListOptGrantOption_14d62736 implements \SqlSemantics\Statement\Model\MySql\Role\GrantCommandForm
{
    ...
    {
        return new self($user, $this->grantList, $this->optGrantOption, $this->comments);
    }
    ...
    {
        return new self($this->user, $grantList, $this->optGrantOption, $this->comments);
    }
    ...
    {
        return new self($this->user, $this->grantList, $optGrantOption, $this->comments);
    }
    ...
    {
        return new self($this->user, $this->grantList, $this->optGrantOption, $comments);
    }
}
