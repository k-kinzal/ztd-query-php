...
final class FilterTableListWithFilterTableListFilterTableIdent_b1477413 implements \SqlSemantics\Statement\Model\MySql\Role\FilterTableListForm
{
    ...
    {
        return new self($filterTableList, $this->filterTableIdent, $this->comments);
    }
    ...
    {
        return new self($this->filterTableList, $filterTableIdent, $this->comments);
    }
    ...
    {
        return new self($this->filterTableList, $this->filterTableIdent, $comments);
    }
}
