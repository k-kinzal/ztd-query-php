...
final class ShowCreateTableTest extends MySqlIntegrationTestCase
{
    public function testShowCreateTableThrowsExceptionInExceptionMode(): void
    {
        ...
        $ztdPdo->query("SHOW CREATE TABLE `{$table}`");
    }

    public function testShowCreateTableIsIgnoredInIgnoreMode(): void
    {
        $table = $this->uniqueTableName('users');
        ...
        $result = $ztdPdo->query("SHOW CREATE TABLE `{$table}`");

        $this->assertFalse($result);
    }

    public function testShowCreateTableTriggersNoticeInNoticeMode(): void
    {
        $table = $this->uniqueTableName('users');
        ...
        try {
            ...
            $this->assertStringContainsString('SHOW CREATE TABLE', $capturedNotices[0]);
        } finally {
