...
final class CommitTest extends MySqlIntegrationTestCase
{
    public function testCommitThrowsExceptionInExceptionMode(): void
    {
    ...
    public function testCommitIsIgnoredInIgnoreMode(): void
    {
        $ztdPdo = $this->createZtdPdoWithConfig(new ZtdConfig(
            unsupportedBehavior: UnsupportedSqlBehavior::Ignore
        ));

        $result = $ztdPdo->exec('COMMIT');

        $this->assertSame(0, $result);
    }

    public function testCommitTriggersNoticeInNoticeMode(): void
    {
        $ztdPdo = $this->createZtdPdoWithConfig(new ZtdConfig(
        ...
        try {
            ...
            $this->assertStringContainsString('COMMIT', $capturedNotices[0]);
        } finally {
