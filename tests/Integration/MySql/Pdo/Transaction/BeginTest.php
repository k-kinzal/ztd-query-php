...
final class BeginTest extends MySqlIntegrationTestCase
{
    public function testBeginThrowsExceptionInExceptionMode(): void
    {
    ...
    public function testBeginIsIgnoredInIgnoreMode(): void
    {
        $ztdPdo = $this->createZtdPdoWithConfig(new ZtdConfig(
            unsupportedBehavior: UnsupportedSqlBehavior::Ignore
        ));

        $result = $ztdPdo->exec('BEGIN');

        $this->assertSame(0, $result);
    }

    public function testBeginTriggersNoticeInNoticeMode(): void
    {
        $ztdPdo = $this->createZtdPdoWithConfig(new ZtdConfig(
        ...
        try {
            ...
            $this->assertStringContainsString('BEGIN', $capturedNotices[0]);
        } finally {
