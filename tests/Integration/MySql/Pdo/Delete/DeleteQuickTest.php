...
final class DeleteQuickTest extends MySqlIntegrationTestCase
{
    public function testDeleteQuickIsSupported(): void
    {
        ...
        $affected = $this->ztdPdo->exec("DELETE QUICK FROM `{$table}` WHERE id = 1");
