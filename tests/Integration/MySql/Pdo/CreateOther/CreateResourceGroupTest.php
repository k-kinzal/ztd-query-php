...
{
    public function testCreateResourceGroupThrowsExceptionInExceptionMode(): void
    {
    ...
    public function testCreateResourceGroupTriggersNoticeInNoticeMode(): void
    {
        $ztdPdo = $this->createZtdPdoWithConfig(new ZtdConfig(
        ...
        try {
            ...
            $this->assertStringContainsString('CREATE RESOURCE GROUP', $capturedNotices[0]);
        } finally {
