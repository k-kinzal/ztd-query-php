...
final class KillTest extends MySqlIntegrationTestCase
{
    public function testKillThrowsExceptionInExceptionMode(): void
    {
        ...
        $ztdPdo->exec('KILL 12345');
    }

    public function testKillIsIgnoredInIgnoreMode(): void
    {
        $ztdPdo = $this->createZtdPdoWithConfig(new ZtdConfig(
            unsupportedBehavior: UnsupportedSqlBehavior::Ignore
        ));

        $result = $ztdPdo->exec('KILL 12345');

        $this->assertSame(0, $result);
    }

    public function testKillTriggersNoticeInNoticeMode(): void
    {
        $ztdPdo = $this->createZtdPdoWithConfig(new ZtdConfig(
        ...
        try {
            ...
            $this->assertStringContainsString('KILL', $capturedNotices[0]);
        } finally {
