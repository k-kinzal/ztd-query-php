...
final class RestartTest extends MySqlIntegrationTestCase
{
    public function testRestartThrowsExceptionInExceptionMode(): void
    {
    ...
    public function testRestartIsIgnoredInIgnoreMode(): void
    {
        $ztdPdo = $this->createZtdPdoWithConfig(new ZtdConfig(
            unsupportedBehavior: UnsupportedSqlBehavior::Ignore
        ));

        $result = $ztdPdo->exec('RESTART');

        $this->assertSame(0, $result);
    }

    public function testRestartTriggersNoticeInNoticeMode(): void
    {
        $ztdPdo = $this->createZtdPdoWithConfig(new ZtdConfig(
        ...
        try {
            ...
            $this->assertStringContainsString('RESTART', $capturedNotices[0]);
        } finally {
