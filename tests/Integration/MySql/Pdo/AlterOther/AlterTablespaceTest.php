...
{
    public function testAlterTablespaceThrowsExceptionInExceptionMode(): void
    {
    ...
    public function testAlterTablespaceTriggersNoticeInNoticeMode(): void
    {
        $ztdPdo = $this->createZtdPdoWithConfig(new ZtdConfig(
        ...
        try {
            ...
            $this->assertStringContainsString('ALTER TABLESPACE', $capturedNotices[0]);
        } finally {
