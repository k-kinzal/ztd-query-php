...
{
    public function testAlterDatabaseThrowsExceptionInExceptionMode(): void
    {
    ...
    public function testAlterDatabaseTriggersNoticeInNoticeMode(): void
    {
        $ztdPdo = $this->createZtdPdoWithConfig(new ZtdConfig(
        ...
        try {
            ...
            $this->assertStringContainsString('ALTER DATABASE', $capturedNotices[0]);
        } finally {
